...
var hx$hiccup$IElement$_as_element$dyn_78938 = (function (el,config){
...
return hx$hiccup$IElement$_as_element$dyn_78938(el,config);
}
});
...
hx$hiccup$parse_tag_$_VarEl.cljs$lang$applyTo = (function (arglist__78941){
...
var fexpr__78921 = new cljs.core.Keyword(null,"create-element","create-element",193243064).cljs$core$IFn$_invoke$arity$1(config);
return (fexpr__78921.cljs$core$IFn$_invoke$arity$3 ? fexpr__78921.cljs$core$IFn$_invoke$arity$3(config,el,args) : fexpr__78921.call(null,config,el,args));
});
...
var a__$1 = this;
return hx.hiccup.make_element(config,new cljs.core.Keyword(null,"fragment","fragment",826775688).cljs$core$IFn$_invoke$arity$1(config),cljs.core.cons(null,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__78923_SHARP_){
return hx.hiccup._as_element(p1__78923_SHARP_,config);
}),a__$1)));
}));
...
return hx.hiccup.make_element(config,new cljs.core.Keyword(null,"fragment","fragment",826775688).cljs$core$IFn$_invoke$arity$1(config),cljs.core.cons(null,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__78924_SHARP_){
return hx.hiccup._as_element(p1__78924_SHARP_,config);
}),a)));
}));
...
if(cljs.core.truth_((function (){var fexpr__78934 = new cljs.core.Keyword(null,"is-element?","is-element?",-1231778016).cljs$core$IFn$_invoke$arity$1(config);
return (fexpr__78934.cljs$core$IFn$_invoke$arity$1 ? fexpr__78934.cljs$core$IFn$_invoke$arity$1(el) : fexpr__78934.call(null,el));
})())){
return el;
} else {
