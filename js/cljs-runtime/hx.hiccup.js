...
var hx$hiccup$IElement$_as_element$dyn_65741 = (function (el,config){
...
return hx$hiccup$IElement$_as_element$dyn_65741(el,config);
}
});
...
while (G__65761__i < G__65761__a.length) {G__65761__a[G__65761__i] = arguments[G__65761__i + 0]; ++G__65761__i;}
  args = new cljs.core.IndexedSeq(G__65761__a,0,null);
} 
return hx$hiccup$parse_tag_$_VarEl__delegate.call(this,args);};
hx$hiccup$parse_tag_$_VarEl.cljs$lang$maxFixedArity = 0;
hx$hiccup$parse_tag_$_VarEl.cljs$lang$applyTo = (function (arglist__65762){
var args = cljs.core.seq(arglist__65762);
...
var fexpr__65718 = new cljs.core.Keyword(null,"create-element","create-element",193243064).cljs$core$IFn$_invoke$arity$1(config);
return (fexpr__65718.cljs$core$IFn$_invoke$arity$3 ? fexpr__65718.cljs$core$IFn$_invoke$arity$3(config,el,args) : fexpr__65718.call(null,config,el,args));
});
...
var a__$1 = this;
return hx.hiccup.make_element(config,new cljs.core.Keyword(null,"fragment","fragment",826775688).cljs$core$IFn$_invoke$arity$1(config),cljs.core.cons(null,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__65725_SHARP_){
return hx.hiccup._as_element(p1__65725_SHARP_,config);
}),a__$1)));
}));
...
return hx.hiccup.make_element(config,new cljs.core.Keyword(null,"fragment","fragment",826775688).cljs$core$IFn$_invoke$arity$1(config),cljs.core.cons(null,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__65726_SHARP_){
return hx.hiccup._as_element(p1__65726_SHARP_,config);
}),a)));
}));
...
if(cljs.core.truth_((function (){var fexpr__65740 = new cljs.core.Keyword(null,"is-element?","is-element?",-1231778016).cljs$core$IFn$_invoke$arity$1(config);
return (fexpr__65740.cljs$core$IFn$_invoke$arity$1 ? fexpr__65740.cljs$core$IFn$_invoke$arity$1(el) : fexpr__65740.call(null,el));
})())){
return el;
} else {
