...
var hx$hiccup$IElement$_as_element$dyn_76538 = (function (el,config){
...
return hx$hiccup$IElement$_as_element$dyn_76538(el,config);
}
});
...
var G__76548__i = 0, G__76548__a = new Array(arguments.length -  0);
while (G__76548__i < G__76548__a.length) {G__76548__a[G__76548__i] = arguments[G__76548__i + 0]; ++G__76548__i;}
  args = new cljs.core.IndexedSeq(G__76548__a,0,null);
} 
return hx$hiccup$parse_tag_$_VarEl__delegate.call(this,args);};
hx$hiccup$parse_tag_$_VarEl.cljs$lang$maxFixedArity = 0;
hx$hiccup$parse_tag_$_VarEl.cljs$lang$applyTo = (function (arglist__76550){
var args = cljs.core.seq(arglist__76550);
...
var fexpr__76500 = new cljs.core.Keyword(null,"create-element","create-element",193243064).cljs$core$IFn$_invoke$arity$1(config);
return (fexpr__76500.cljs$core$IFn$_invoke$arity$3 ? fexpr__76500.cljs$core$IFn$_invoke$arity$3(config,el,args) : fexpr__76500.call(null,config,el,args));
});
...
var a__$1 = this;
return hx.hiccup.make_element(config,new cljs.core.Keyword(null,"fragment","fragment",826775688).cljs$core$IFn$_invoke$arity$1(config),cljs.core.cons(null,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__76509_SHARP_){
return hx.hiccup._as_element(p1__76509_SHARP_,config);
}),a__$1)));
}));
...
return hx.hiccup.make_element(config,new cljs.core.Keyword(null,"fragment","fragment",826775688).cljs$core$IFn$_invoke$arity$1(config),cljs.core.cons(null,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__76511_SHARP_){
return hx.hiccup._as_element(p1__76511_SHARP_,config);
}),a)));
}));
...
if(cljs.core.truth_((function (){var fexpr__76532 = new cljs.core.Keyword(null,"is-element?","is-element?",-1231778016).cljs$core$IFn$_invoke$arity$1(config);
return (fexpr__76532.cljs$core$IFn$_invoke$arity$1 ? fexpr__76532.cljs$core$IFn$_invoke$arity$1(el) : fexpr__76532.call(null,el));
})())){
return el;
} else {
