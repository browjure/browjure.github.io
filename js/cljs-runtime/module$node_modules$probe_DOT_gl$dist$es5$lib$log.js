...
JSCompiler_object_inline_debug_4335=_globals.isBrowser?console.debug||console.log:console.log,JSCompiler_object_inline_log_4336=console.log,JSCompiler_object_inline_info_4337=console.info,JSCompiler_object_inline_warn_4338=console.warn,JSCompiler_object_inline_error_4339=console.error,DEFAULT_SETTINGS={enabled:!0,level:0},cache={},ONCE={once:!0};require=function(){function Log(){var id=(0<arguments.length&&void 0!==arguments[0]?arguments[0]:{}).id;(0,_classCallCheck2["default"])(this,Log);this.id=
...
return this}},{key:"assert",value:function(condition,message){(0,_assert2["default"])(condition,message)}},{key:"warn",value:function(message){return this._getLogFunction(0,message,JSCompiler_object_inline_warn_4338,arguments,ONCE)}},{key:"error",value:function(message){return this._getLogFunction(0,message,JSCompiler_object_inline_error_4339,arguments)}},{key:"deprecated",value:function(oldUsage,newUsage){return this.warn("`".concat(oldUsage,"` is deprecated and will be removed in a later version. Use `").concat(newUsage,
"` instead"))}},{key:"removed",value:function(oldUsage,newUsage){return this.error("`".concat(oldUsage,"` has been removed. Use `").concat(newUsage,"` instead"))}},{key:"probe",value:function(logLevel,message){return this._getLogFunction(logLevel,message,JSCompiler_object_inline_log_4336,arguments,{time:!0,once:!0})}},{key:"log",value:function(logLevel,message){return this._getLogFunction(logLevel,message,JSCompiler_object_inline_debug_4335,arguments)}},{key:"info",value:function(logLevel,message){return this._getLogFunction(logLevel,
message,console.info,arguments)}},{key:"once",value:function(logLevel,message){return this._getLogFunction(logLevel,message,JSCompiler_object_inline_debug_4335||JSCompiler_object_inline_info_4337,arguments,ONCE)}},{key:"table",value:function(logLevel,_table,columns){return _table?this._getLogFunction(logLevel,_table,console.table||noop,columns&&[columns],{tag:getTableHeader(_table)}):noop}},{key:"image",value:function(_ref2){var priority=_ref2.priority,_image=_ref2.image,_ref2$message=_ref2.message;
