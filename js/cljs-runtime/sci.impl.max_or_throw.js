...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_63723 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_63723(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__63690 = (n - (1));
var G__63691 = cljs.core.rest(s);
var G__63692 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__63690,G__63691,G__63692) : sci.impl.max_or_throw.take_STAR_.call(null,G__63690,G__63691,G__63692));
})());
} else {
return null;
}
