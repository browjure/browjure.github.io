...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_74292 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_74292(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__74254 = (n - (1));
var G__74255 = cljs.core.rest(s);
var G__74256 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__74254,G__74255,G__74256) : sci.impl.max_or_throw.take_STAR_.call(null,G__74254,G__74255,G__74256));
})());
} else {
return null;
}
