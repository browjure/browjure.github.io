...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_63470 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_63470(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__63410 = (n - (1));
var G__63411 = cljs.core.rest(s);
var G__63412 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__63410,G__63411,G__63412) : sci.impl.max_or_throw.take_STAR_.call(null,G__63410,G__63411,G__63412));
})());
} else {
return null;
}
