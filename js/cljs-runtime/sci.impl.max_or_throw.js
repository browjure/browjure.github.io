...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_64136 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_64136(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__64094 = (n - (1));
var G__64095 = cljs.core.rest(s);
var G__64096 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__64094,G__64095,G__64096) : sci.impl.max_or_throw.take_STAR_.call(null,G__64094,G__64095,G__64096));
})());
} else {
return null;
}
