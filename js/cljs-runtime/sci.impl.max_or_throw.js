...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_72429 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_72429(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__72385 = (n - (1));
var G__72386 = cljs.core.rest(s);
var G__72387 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__72385,G__72386,G__72387) : sci.impl.max_or_throw.take_STAR_.call(null,G__72385,G__72386,G__72387));
})());
} else {
return null;
}
