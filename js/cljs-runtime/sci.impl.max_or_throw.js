...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_120381 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_120381(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__120327 = (n - (1));
var G__120328 = cljs.core.rest(s);
var G__120329 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__120327,G__120328,G__120329) : sci.impl.max_or_throw.take_STAR_.call(null,G__120327,G__120328,G__120329));
})());
} else {
return null;
}
