...
tile.eastNorthUp=arrayBuffer.getGlobalProperty("EAST_NORTH_UP");tile.rtcCenter=arrayBuffer.getGlobalProperty("RTC_CENTER",_math.GL.FLOAT,3);new _tile3dBatchTable["default"](tile.batchTableJson,tile.batchTableBinary,options);var JSCompiler_object_inline_scale_6614;view=Array(options);var instancePosition=new _core.Vector3;new _core.Vector3;new _core.Vector3;new _core.Vector3;for(var instanceRotation=new _core.Matrix3,instanceQuaternion=new _core.Quaternion,instanceScale=new _core.Vector3,instanceTransform=
new _core.Matrix4,scratch1=[],scratch2=[],scratchVector1=new _core.Vector3,scratchVector2=new _core.Vector3,i=0;i<options;i++){var JSCompiler_object_inline_translation_6612=void 0;if(arrayBuffer.hasProperty("POSITION"))JSCompiler_object_inline_translation_6612=arrayBuffer.getProperty("POSITION",_math.GL.FLOAT,3,i,instancePosition);else if(arrayBuffer.hasProperty("POSITION_QUANTIZED")){JSCompiler_object_inline_translation_6612=arrayBuffer.getProperty("POSITION_QUANTIZED",_math.GL.UNSIGNED_SHORT,3,
i,instancePosition);var JSCompiler_object_inline_rotation_6613=arrayBuffer.getGlobalProperty("QUANTIZED_VOLUME_OFFSET",_math.GL.FLOAT,3,scratchVector1);if(!JSCompiler_object_inline_rotation_6613)throw Error("i3dm parser: QUANTIZED_VOLUME_OFFSET must be defined for quantized positions.");var quantizedVolumeScale=arrayBuffer.getGlobalProperty("QUANTIZED_VOLUME_SCALE",_math.GL.FLOAT,3,scratchVector2);if(!quantizedVolumeScale)throw Error("i3dm parser: QUANTIZED_VOLUME_SCALE must be defined for quantized positions.");
for(JSCompiler_object_inline_scale_6614=0;3>JSCompiler_object_inline_scale_6614;JSCompiler_object_inline_scale_6614++)JSCompiler_object_inline_translation_6612[JSCompiler_object_inline_scale_6614]=JSCompiler_object_inline_translation_6612[JSCompiler_object_inline_scale_6614]/65535*quantizedVolumeScale[JSCompiler_object_inline_scale_6614]+JSCompiler_object_inline_rotation_6613[JSCompiler_object_inline_scale_6614]}if(!JSCompiler_object_inline_translation_6612)throw Error("i3dm: POSITION or POSITION_QUANTIZED must be defined for each instance.");
instancePosition.copy(JSCompiler_object_inline_translation_6612);JSCompiler_object_inline_translation_6612=instancePosition;tile.normalUp=arrayBuffer.getProperty("NORMAL_UP",_math.GL.FLOAT,3,i,scratch1);tile.normalRight=arrayBuffer.getProperty("NORMAL_RIGHT",_math.GL.FLOAT,3,i,scratch2);if(tile.normalUp){if(!tile.normalRight)throw Error("i3dm: Custom orientation requires both NORMAL_UP and NORMAL_RIGHT.");tile.hasCustomOrientation=!0}else{tile.octNormalUp=arrayBuffer.getProperty("NORMAL_UP_OCT32P",
...
instanceRotation.identity()}instanceQuaternion.fromMatrix3(instanceRotation);JSCompiler_object_inline_rotation_6613=instanceQuaternion;instanceScale.set(1,1,1);quantizedVolumeScale=arrayBuffer.getProperty("SCALE",_math.GL.FLOAT,1,i);Number.isFinite(quantizedVolumeScale)&&instanceScale.multiplyByScalar(quantizedVolumeScale);(quantizedVolumeScale=arrayBuffer.getProperty("SCALE_NON_UNIFORM",_math.GL.FLOAT,3,i,scratch1))&&instanceScale.scale(quantizedVolumeScale);JSCompiler_object_inline_scale_6614=instanceScale;
quantizedVolumeScale=arrayBuffer.getProperty("BATCH_ID",_math.GL.UNSIGNED_SHORT,1,i);void 0===quantizedVolumeScale&&(quantizedVolumeScale=i);JSCompiler_object_inline_rotation_6613=(new _core.Matrix4).fromQuaternion(JSCompiler_object_inline_rotation_6613);instanceTransform.identity();instanceTransform.translate(JSCompiler_object_inline_translation_6612);instanceTransform.multiplyRight(JSCompiler_object_inline_rotation_6613);instanceTransform.scale(JSCompiler_object_inline_scale_6614);JSCompiler_object_inline_translation_6612=
instanceTransform.clone();view[i]={modelMatrix:JSCompiler_object_inline_translation_6612,batchId:quantizedVolumeScale}}tile.instances=view;byteOffset$jscomp$0=byteOffset;_context.next=3;return(0,_parse3dTileGltfView.extractGLTF)(tile$jscomp$0,tile$jscomp$0.gltfFormat,options$jscomp$0,context);case 3:return _context.abrupt("return",byteOffset$jscomp$0);case 4:case "end":return _context.stop()}},_callee)}));return _parseInstancedModel3DTile.apply(this,arguments)}global=require("module$node_modules$$babel$runtime$helpers$interopRequireDefault");
