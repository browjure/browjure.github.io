...
position,!0);position+=bytesCount}}catch(err){_iterator.e(err)}finally{_iterator.f()}if(options.maxDecodingStep<DECODING_STEPS.vertices)return{header:userOptions};_step$value=position;bytesCount=data.getUint32(_step$value,!0);_step=new Uint16Array(3*bytesCount);_step$value+=Uint32Array.BYTES_PER_ELEMENT;position=Uint16Array.BYTES_PER_ELEMENT;_iterator=bytesCount*position;var uArrayStartPosition=_step$value;var JSCompiler_object_inline_edgeIndicesEndPosition_6622=uArrayStartPosition+_iterator;for(var heightArrayStartPosition=
JSCompiler_object_inline_edgeIndicesEndPosition_6622+_iterator,u=0,v=0,height=0,i=0;i<bytesCount;i++)u+=decodeZigZag(data.getUint16(uArrayStartPosition+position*i,!0)),v+=decodeZigZag(data.getUint16(JSCompiler_object_inline_edgeIndicesEndPosition_6622+position*i,!0)),height+=decodeZigZag(data.getUint16(heightArrayStartPosition+position*i,!0)),_step[i]=u,_step[i+bytesCount]=v,_step[i+2*bytesCount]=height;if(options.maxDecodingStep<DECODING_STEPS.triangleIndices)return{header:userOptions,vertexData:_step};
bytesCount=_step$value+3*_iterator;position=65536<_step.length/3?Uint32Array.BYTES_PER_ELEMENT:Uint16Array.BYTES_PER_ELEMENT;0!==bytesCount%position&&(bytesCount+=position-bytesCount%position);_step$value=data.getUint32(bytesCount,!0);bytesCount+=Uint32Array.BYTES_PER_ELEMENT;_iterator=3*_step$value;_step$value=decodeIndex(data.buffer,bytesCount,_iterator,position);if(options.maxDecodingStep<DECODING_STEPS.edgeIndices)return{header:userOptions,vertexData:_step,triangleIndices:_step$value};JSCompiler_object_inline_edgeIndicesEndPosition_6622=
bytesCount+_iterator*position;heightArrayStartPosition=65536<_step.length/3?Uint32Array.BYTES_PER_ELEMENT:Uint16Array.BYTES_PER_ELEMENT;position=data.getUint32(JSCompiler_object_inline_edgeIndicesEndPosition_6622,!0);JSCompiler_object_inline_edgeIndicesEndPosition_6622+=Uint32Array.BYTES_PER_ELEMENT;bytesCount=decodeIndex(data.buffer,JSCompiler_object_inline_edgeIndicesEndPosition_6622,position,heightArrayStartPosition,!1);JSCompiler_object_inline_edgeIndicesEndPosition_6622+=position*heightArrayStartPosition;
_iterator=data.getUint32(JSCompiler_object_inline_edgeIndicesEndPosition_6622,!0);JSCompiler_object_inline_edgeIndicesEndPosition_6622+=Uint32Array.BYTES_PER_ELEMENT;position=decodeIndex(data.buffer,JSCompiler_object_inline_edgeIndicesEndPosition_6622,_iterator,heightArrayStartPosition,!1);JSCompiler_object_inline_edgeIndicesEndPosition_6622+=_iterator*heightArrayStartPosition;uArrayStartPosition=data.getUint32(JSCompiler_object_inline_edgeIndicesEndPosition_6622,!0);JSCompiler_object_inline_edgeIndicesEndPosition_6622+=
Uint32Array.BYTES_PER_ELEMENT;_iterator=decodeIndex(data.buffer,JSCompiler_object_inline_edgeIndicesEndPosition_6622,uArrayStartPosition,heightArrayStartPosition,!1);JSCompiler_object_inline_edgeIndicesEndPosition_6622+=uArrayStartPosition*heightArrayStartPosition;u=data.getUint32(JSCompiler_object_inline_edgeIndicesEndPosition_6622,!0);JSCompiler_object_inline_edgeIndicesEndPosition_6622+=Uint32Array.BYTES_PER_ELEMENT;uArrayStartPosition=decodeIndex(data.buffer,JSCompiler_object_inline_edgeIndicesEndPosition_6622,
u,heightArrayStartPosition,!1);JSCompiler_object_inline_edgeIndicesEndPosition_6622+=u*heightArrayStartPosition;if(options.maxDecodingStep<DECODING_STEPS.extensions)return{header:userOptions,vertexData:_step,triangleIndices:_step$value,westIndices:bytesCount,northIndices:uArrayStartPosition,eastIndices:_iterator,southIndices:position};options={};if(!(data.byteLength<=JSCompiler_object_inline_edgeIndicesEndPosition_6622))for(;JSCompiler_object_inline_edgeIndicesEndPosition_6622<data.byteLength;){heightArrayStartPosition=
data.getUint8(JSCompiler_object_inline_edgeIndicesEndPosition_6622,!0);JSCompiler_object_inline_edgeIndicesEndPosition_6622+=Uint8Array.BYTES_PER_ELEMENT;u=data.getUint32(JSCompiler_object_inline_edgeIndicesEndPosition_6622,!0);JSCompiler_object_inline_edgeIndicesEndPosition_6622+=Uint32Array.BYTES_PER_ELEMENT;v=new DataView(data.buffer,JSCompiler_object_inline_edgeIndicesEndPosition_6622,u);switch(heightArrayStartPosition){case 1:options.vertexNormals=new Uint8Array(v.buffer,v.byteOffset,v.byteLength);
break;case 2:options.waterMask=v.buffer.slice(v.byteOffset,v.byteOffset+v.byteLength)}JSCompiler_object_inline_edgeIndicesEndPosition_6622+=u}return{header:userOptions,vertexData:_step,triangleIndices:_step$value,westIndices:bytesCount,northIndices:uArrayStartPosition,eastIndices:_iterator,southIndices:position,extensions:options}};exports.DECODING_STEPS=void 0;var _slicedToArray2=global(require("module$node_modules$$babel$runtime$helpers$slicedToArray")),QUANTIZED_MESH_HEADER=new Map([["centerX",
