...
function findNativeHandler(_ref){var start=_ref.start,current=_ref.current,anchor=_ref.anchor,JSCompiler_object_inline_scrollPosition_4296={x:"scrollLeft",y:"scrollTop"},JSCompiler_object_inline_scrollLength_4297={x:"scrollWidth",y:"scrollHeight"},JSCompiler_object_inline_clientLength_4298={x:"clientWidth",y:"clientHeight"};return _ref.domTreeShapes.some(function(shape){var goingForward=current>=start;if("top"===anchor||"left"===anchor)goingForward=!goingForward;var axis="left"===anchor||"right"===
anchor?"x":"y",scrollPosition=shape[JSCompiler_object_inline_scrollPosition_4296[axis]];axis=scrollPosition+shape[JSCompiler_object_inline_clientLength_4298[axis]]<shape[JSCompiler_object_inline_scrollLength_4297[axis]];return goingForward&&axis||!goingForward&&0<scrollPosition?shape:null})}var _interopRequireWildcard=require("module$node_modules$$babel$runtime$helpers$interopRequireWildcard"),_interopRequireDefault=require("module$node_modules$$babel$runtime$helpers$interopRequireDefault");Object.defineProperty(exports,
