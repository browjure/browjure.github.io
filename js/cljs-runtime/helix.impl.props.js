...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__66460_SHARP_,p2__66459_SHARP_){
return p2__66459_SHARP_.toUpperCase();
}));
...
while(true){
if(cljs.core.seq(m)){
var G__66598 = cljs.core.rest(m);
var G__66599 = (function (){var entry = cljs.core.first(m);
...
var G__66500 = o1;
goog.object.extend(G__66500,o2);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66517_SHARP_){
if(cljs.core.map_QMARK_(p1__66517_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__66517_SHARP_);
} else {
return p1__66517_SHARP_;
}
}),style));
} else {
return style;
...
while(true){
if(cljs.core.seq(m)){
var G__66613 = cljs.core.rest(m);
var G__66614 = (function (){var entry = cljs.core.first(m);
var k = cljs.core.key(entry);
var v = cljs.core.val(entry);
var G__66531 = k;
var G__66531__$1 = (((G__66531 instanceof cljs.core.Keyword))?G__66531.fqn:null);
switch (G__66531__$1) {
case "class":
...
while(true){
if(cljs.core.seq(m)){
var G__66625 = cljs.core.rest(m);
var G__66626 = (function (){var entry = cljs.core.first(m);
