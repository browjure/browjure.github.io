...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__66488_SHARP_,p2__66487_SHARP_){
return p2__66487_SHARP_.toUpperCase();
}));
...
while(true){
if(cljs.core.seq(m)){
var G__66581 = cljs.core.rest(m);
var G__66582 = (function (){var entry = cljs.core.first(m);
...
var G__66506 = o1;
goog.object.extend(G__66506,o2);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66533_SHARP_){
if(cljs.core.map_QMARK_(p1__66533_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__66533_SHARP_);
} else {
return p1__66533_SHARP_;
}
}),style));
} else {
return style;
...
while(true){
if(cljs.core.seq(m)){
var G__66595 = cljs.core.rest(m);
var G__66596 = (function (){var entry = cljs.core.first(m);
var k = cljs.core.key(entry);
var v = cljs.core.val(entry);
var G__66551 = k;
var G__66551__$1 = (((G__66551 instanceof cljs.core.Keyword))?G__66551.fqn:null);
switch (G__66551__$1) {
case "class":
...
while(true){
if(cljs.core.seq(m)){
var G__66611 = cljs.core.rest(m);
var G__66612 = (function (){var entry = cljs.core.first(m);
