...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__75295_SHARP_,p2__75294_SHARP_){
return p2__75294_SHARP_.toUpperCase();
}));
...
while(true){
if(cljs.core.seq(m)){
var G__75358 = cljs.core.rest(m);
var G__75359 = (function (){var entry = cljs.core.first(m);
...
var G__75314 = o1;
goog.object.extend(G__75314,o2);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__75317_SHARP_){
if(cljs.core.map_QMARK_(p1__75317_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__75317_SHARP_);
} else {
...
while(true){
if(cljs.core.seq(m)){
var G__75389 = cljs.core.rest(m);
var G__75390 = (function (){var entry = cljs.core.first(m);
var k = cljs.core.key(entry);
var v = cljs.core.val(entry);
var G__75327 = k;
var G__75327__$1 = (((G__75327 instanceof cljs.core.Keyword))?G__75327.fqn:null);
switch (G__75327__$1) {
case "class":
...
while(true){
if(cljs.core.seq(m)){
var G__75398 = cljs.core.rest(m);
var G__75399 = (function (){var entry = cljs.core.first(m);
