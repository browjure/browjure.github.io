...
":"+(vegaUtil.isObject(value)?value.signal||propertyLambda(value):vegaUtil.stringValue(value));return code+"}"}function defaults$jscomp$0(){return{description:"Vega visualization",padding:0,autosize:"pad",background:null,events:{defaults:{allow:["wheel"]}},group:null,mark:null,arc:{fill:"#4c78a8"},area:{fill:"#4c78a8"},image:null,line:{stroke:"#4c78a8",strokeWidth:2},path:{stroke:"#4c78a8"},rect:{fill:"#4c78a8"},rule:{stroke:"#000"},shape:{stroke:"#4c78a8"},symbol:{fill:"#4c78a8",size:64},text:{fill:"#000",
...
"legend-label";exports.LegendRole="legend";exports.LegendSymbolRole="legend-symbol";exports.LegendTitleRole="legend-title";exports.MarkRole="mark";exports.Scope=Scope$1;exports.ScopeRole="scope";exports.config=defaults$jscomp$0;exports.parse=function(spec,config,options){vegaUtil.isObject(spec)||vegaUtil.error("Input Vega specification must be an object.");config=vegaUtil.mergeConfig(defaults$jscomp$0(),config,spec.config);return parseView(spec,new Scope$1(config,options)).toRuntime()};exports.signal=
parseSignal;exports.signalUpdates=parseSignalUpdates;exports.stream=parseStream;Object.defineProperty(exports,"__esModule",{value:!0})})}
