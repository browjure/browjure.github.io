...
var G__60240 = devtools.prefs.pref(v);
v = G__60240;
continue;
} else {
return v;
...
}catch (e60196){var _e__58832__auto__ = e60196;
return false;
}})();
...
}catch (e60204){var _e__58832__auto__ = e60204;
return false;
}})();
...
}catch (e60206){var _e__58832__auto__ = e60206;
return false;
}}
}
});
...
var vec__60226 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60226,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60226,(1),null);
...
return cljs.core.some((function (p1__60234_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__60234_SHARP_);
}),template);
});
