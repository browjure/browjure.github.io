...
var G__118148 = devtools.prefs.pref(v);
v = G__118148;
continue;
} else {
return v;
...
}catch (e118095){var _e__57929__auto__ = e118095;
return false;
}})();
...
}catch (e118101){var _e__57929__auto__ = e118101;
return false;
}})();
...
}catch (e118106){var _e__57929__auto__ = e118106;
return false;
}}
}
});
...
var vec__118116 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__118116,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__118116,(1),null);
...
return cljs.core.some((function (p1__118123_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__118123_SHARP_);
}),template);
});
