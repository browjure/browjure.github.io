...
var G__58470 = devtools.prefs.pref(v);
v = G__58470;
continue;
} else {
return v;
...
}catch (e58420){var _e__57494__auto__ = e58420;
return false;
}})();
...
}catch (e58425){var _e__57494__auto__ = e58425;
return false;
}})();
...
}catch (e58429){var _e__57494__auto__ = e58429;
return false;
}}
}
});
...
var vec__58450 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58450,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58450,(1),null);
...
return cljs.core.some((function (p1__58458_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__58458_SHARP_);
}),template);
});
