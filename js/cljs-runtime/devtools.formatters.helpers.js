...
var G__70237 = devtools.prefs.pref(v);
v = G__70237;
continue;
} else {
return v;
...
}catch (e70195){var _e__58001__auto__ = e70195;
return false;
}})();
...
}catch (e70203){var _e__58001__auto__ = e70203;
return false;
}})();
...
}catch (e70206){var _e__58001__auto__ = e70206;
return false;
}}
}
});
...
var vec__70220 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70220,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70220,(1),null);
...
return cljs.core.some((function (p1__70224_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__70224_SHARP_);
}),template);
});
