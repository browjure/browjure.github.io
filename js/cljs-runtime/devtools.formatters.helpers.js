...
var G__72035 = devtools.prefs.pref(v);
v = G__72035;
continue;
} else {
return v;
...
}catch (e71995){var _e__57997__auto__ = e71995;
return false;
}})();
...
}catch (e72001){var _e__57997__auto__ = e72001;
return false;
}})();
...
}catch (e72009){var _e__57997__auto__ = e72009;
return false;
}}
}
});
...
var vec__72024 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72024,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72024,(1),null);
...
return cljs.core.some((function (p1__72027_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__72027_SHARP_);
}),template);
});
