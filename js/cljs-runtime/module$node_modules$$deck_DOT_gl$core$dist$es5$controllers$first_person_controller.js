...
JSCompiler_object_inline_position_4449=[0,0,0],LINEAR_TRANSITION_PROPS={transitionDuration:300,transitionEasing:function(t){return t},transitionInterpolator:new _interopRequireDefault["default"](["position","pitch","bearing"]),transitionInterruption:_transitionManager.TRANSITION_EVENTS.BREAK},FirstPersonState=function(_ViewState){function FirstPersonState(_ref){var _this=_ref.width;var height=_ref.height,_ref$position=_ref.position;_ref$position=void 0===_ref$position?JSCompiler_object_inline_position_4449:
