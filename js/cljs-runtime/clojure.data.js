...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__59986){
var vec__59989 = p__59986;
...
var vec__60002 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60002,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60002,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60002,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_60196 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_60196(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_60212 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_60212(a,b);
}
});
...
var fexpr__60139 = (function (){var G__60140 = clojure.data.equality_partition(a);
var G__60140__$1 = (((G__60140 instanceof cljs.core.Keyword))?G__60140.fqn:null);
switch (G__60140__$1) {
case "atom":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__60140__$1)].join('')));

}
})();
return (fexpr__60139.cljs$core$IFn$_invoke$arity$2 ? fexpr__60139.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__60139.call(null,a,b));
}));
/**
