...
var o69407 = temp__5751__auto__;
var temp__5751__auto____$1 = (o69407["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o69408 = temp__5751__auto____$1;
return (o69408["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__57994__auto__ = f;
return (o__57994__auto__["toString"]).call(o__57994__auto__);
} else {
return "";
}
}catch (e69412){var _ = e69412;
return "";
}});
...
try{var o__57994__auto___70019 = t;
(o__57994__auto___70019["cljs$lang$ctorPrWriter"]).call(o__57994__auto___70019,t,writer);
}catch (e69450){var __70023 = e69450;
}
...
var char_code = (function (){var o__57994__auto__ = (new String(char$));
return (o__57994__auto__["charCodeAt"]).call(o__57994__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__57994__auto__ = String;
return (o__57994__auto__["fromCharCode"]).call(o__57994__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__69489 = num_code;
switch (G__69489) {
case (1):
return (185);
...
var o__57994__auto__ = String;
return (o__57994__auto__["fromCharCode"]).call(o__57994__auto__,superscript_code);
});
/**
...
}catch (e69556){var _e__58001__auto__ = e69556;
return false;
}})())){
...
var vec__69562 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69562,(0),null);
...
var len__4736__auto___70073 = arguments.length;
var i__4737__auto___70074 = (0);
while(true){
if((i__4737__auto___70074 < len__4736__auto___70073)){
args__4742__auto__.push((arguments[i__4737__auto___70074]));

var G__70075 = (i__4737__auto___70074 + (1));
i__4737__auto___70074 = G__70075;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__69624){
var vec__69627 = p__69624;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69627,(0),null);
...
var G__70085 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__70086 = cljs.core.butlast(remaining_tokens);
name_tokens = G__70085;
remaining_tokens = G__70086;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq69607){
var G__69608 = cljs.core.first(seq69607);
var seq69607__$1 = cljs.core.next(seq69607);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__69608,seq69607__$1);
}));
...
var vec__69681 = cljs.core.split_with((function (p1__69676_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__69676_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69681,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69681,(1),null);
...
var vec__69702 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69702,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69702,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__70106 = cljs.core.rest(remaining_tokens);
var G__70107 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__70106;
name_tokens = G__70107;
continue;
} else {
...
var vec__69719 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69719,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69719,(1),null);
var vec__69722 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69722,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69722,(1),null);
var vec__69725 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69725,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69725,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69725,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69725,(3),null);
...
var vec__69745 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69745,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69745,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69745,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69745,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69745,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69745,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__69751 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69751,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69751,(1),null);
var vec__69756 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69756,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69756,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__69773 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__69773) : devtools.munging.parse_fn_info_deep.call(null,G__69773));
})()));
}
} else {
return fn_info;
...
var G__70166 = (arity + (1));
var G__70167 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__69806){
var vec__69808 = p__69806;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69808,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69808,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__69826_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__69826_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__69827_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__69827_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___70182 = arguments.length;
var i__4737__auto___70183 = (0);
while(true){
if((i__4737__auto___70183 < len__4736__auto___70182)){
args__4742__auto__.push((arguments[i__4737__auto___70183]));

var G__70184 = (i__4737__auto___70183 + (1));
i__4737__auto___70183 = G__70184;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__69838){
var vec__69839 = p__69838;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69839,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq69830){
var G__69831 = cljs.core.first(seq69830);
var seq69830__$1 = cljs.core.next(seq69830);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__69831,seq69830__$1);
}));
...
var G__69851 = arg;
var G__69851__$1 = (((G__69851 instanceof cljs.core.Keyword))?G__69851.fqn:null);
switch (G__69851__$1) {
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69886__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69886__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69886__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69886__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__69887 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69887,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69887,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69887,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69887,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69887,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69887,(5),null);
...
var o__57994__auto__ = f;
return (o__57994__auto__["getBasis"]).call(o__57994__auto__);
});
/**
...
}catch (e69911){var _e__58001__auto__ = e69911;
...
var G__70209 = (obj[cljs.core.first(path)]);
var G__70210 = cljs.core.rest(path);
obj = G__70209;
path = G__70210;
continue;
} else {
...
var _STAR_ = (function (accum,p__69946){
var vec__69948 = p__69946;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69948,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69948,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__69966){
var vec__69968 = p__69966;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69968,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69968,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69968,(2),null);
...
var post_process = (function (p__69988){
var vec__69990 = p__69988;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69990,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69990,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__69977_SHARP_){
return (obj[cljs.core.first(p1__69977_SHARP_)]);
}),sorted_matches);
