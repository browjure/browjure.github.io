...
var o59263 = temp__5751__auto__;
var temp__5751__auto____$1 = (o59263["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o59264 = temp__5751__auto____$1;
return (o59264["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__58807__auto__ = f;
return (o__58807__auto__["toString"]).call(o__58807__auto__);
} else {
return "";
}
}catch (e59272){var _ = e59272;
return "";
}});
...
try{var o__58807__auto___59790 = t;
(o__58807__auto___59790["cljs$lang$ctorPrWriter"]).call(o__58807__auto___59790,t,writer);
}catch (e59285){var __59791 = e59285;
}
...
var char_code = (function (){var o__58807__auto__ = (new String(char$));
return (o__58807__auto__["charCodeAt"]).call(o__58807__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__58807__auto__ = String;
return (o__58807__auto__["fromCharCode"]).call(o__58807__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__59313 = num_code;
switch (G__59313) {
case (1):
return (185);
...
var o__58807__auto__ = String;
return (o__58807__auto__["fromCharCode"]).call(o__58807__auto__,superscript_code);
});
/**
...
}catch (e59342){var _e__58832__auto__ = e59342;
return false;
}})())){
...
var vec__59353 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59353,(0),null);
...
var len__4736__auto___59835 = arguments.length;
var i__4737__auto___59836 = (0);
while(true){
if((i__4737__auto___59836 < len__4736__auto___59835)){
args__4742__auto__.push((arguments[i__4737__auto___59836]));

var G__59837 = (i__4737__auto___59836 + (1));
i__4737__auto___59836 = G__59837;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__59409){
var vec__59410 = p__59409;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59410,(0),null);
...
var G__59844 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__59845 = cljs.core.butlast(remaining_tokens);
name_tokens = G__59844;
remaining_tokens = G__59845;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq59401){
var G__59402 = cljs.core.first(seq59401);
var seq59401__$1 = cljs.core.next(seq59401);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__59402,seq59401__$1);
}));
...
var vec__59433 = cljs.core.split_with((function (p1__59427_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__59427_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59433,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59433,(1),null);
...
var vec__59446 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59446,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59446,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__59869 = cljs.core.rest(remaining_tokens);
var G__59870 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__59869;
name_tokens = G__59870;
continue;
} else {
...
var vec__59471 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59471,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59471,(1),null);
var vec__59474 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59474,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59474,(1),null);
var vec__59477 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59477,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59477,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59477,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59477,(3),null);
...
var vec__59492 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59492,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59492,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59492,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59492,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59492,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59492,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__59499 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59499,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59499,(1),null);
var vec__59502 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59502,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59502,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__59567 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__59567) : devtools.munging.parse_fn_info_deep.call(null,G__59567));
})()));
}
} else {
return fn_info;
...
var G__59930 = (arity + (1));
var G__59931 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__59596){
var vec__59597 = p__59596;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59597,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59597,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59604_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__59604_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59605_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__59605_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___59964 = arguments.length;
var i__4737__auto___59966 = (0);
while(true){
if((i__4737__auto___59966 < len__4736__auto___59964)){
args__4742__auto__.push((arguments[i__4737__auto___59966]));

var G__59968 = (i__4737__auto___59966 + (1));
i__4737__auto___59966 = G__59968;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__59608){
var vec__59609 = p__59608;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59609,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq59606){
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59627__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59627__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59627__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59627__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__59628 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59628,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59628,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59628,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59628,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59628,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59628,(5),null);
...
var o__58807__auto__ = f;
return (o__58807__auto__["getBasis"]).call(o__58807__auto__);
});
/**
...
}catch (e59684){var _e__58832__auto__ = e59684;
...
var G__60022 = (obj[cljs.core.first(path)]);
var G__60023 = cljs.core.rest(path);
obj = G__60022;
path = G__60023;
continue;
} else {
...
var _STAR_ = (function (accum,p__59719){
var vec__59720 = p__59719;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59720,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59720,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__59736){
var vec__59739 = p__59736;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59739,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59739,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59739,(2),null);
...
var post_process = (function (p__59758){
var vec__59759 = p__59758;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59759,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59759,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59751_SHARP_){
return (obj[cljs.core.first(p1__59751_SHARP_)]);
}),sorted_matches);
