...
var o71033 = temp__5751__auto__;
var temp__5751__auto____$1 = (o71033["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o71034 = temp__5751__auto____$1;
return (o71034["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__57990__auto__ = f;
return (o__57990__auto__["toString"]).call(o__57990__auto__);
} else {
return "";
}
}catch (e71035){var _ = e71035;
return "";
}});
...
try{var o__57990__auto___71499 = t;
(o__57990__auto___71499["cljs$lang$ctorPrWriter"]).call(o__57990__auto___71499,t,writer);
}catch (e71042){var __71501 = e71042;
}
...
var char_code = (function (){var o__57990__auto__ = (new String(char$));
return (o__57990__auto__["charCodeAt"]).call(o__57990__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__57990__auto__ = String;
return (o__57990__auto__["fromCharCode"]).call(o__57990__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__71067 = num_code;
switch (G__71067) {
case (1):
return (185);
...
var o__57990__auto__ = String;
return (o__57990__auto__["fromCharCode"]).call(o__57990__auto__,superscript_code);
});
/**
...
}catch (e71074){var _e__57997__auto__ = e71074;
return false;
}})())){
...
var vec__71078 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71078,(0),null);
...
var G__71536 = (i__4737__auto___71533 + (1));
i__4737__auto___71533 = G__71536;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__71112){
var vec__71113 = p__71112;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71113,(0),null);
...
var G__71544 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__71545 = cljs.core.butlast(remaining_tokens);
name_tokens = G__71544;
remaining_tokens = G__71545;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq71105){
var G__71106 = cljs.core.first(seq71105);
var seq71105__$1 = cljs.core.next(seq71105);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__71106,seq71105__$1);
}));
...
var vec__71133 = cljs.core.split_with((function (p1__71132_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__71132_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71133,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71133,(1),null);
...
var vec__71149 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71149,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71149,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__71560 = cljs.core.rest(remaining_tokens);
var G__71561 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__71560;
name_tokens = G__71561;
continue;
} else {
...
var vec__71184 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71184,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71184,(1),null);
var vec__71187 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71187,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71187,(1),null);
var vec__71190 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71190,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71190,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71190,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71190,(3),null);
...
var vec__71215 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71215,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71215,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71215,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71215,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71215,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71215,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__71222 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71222,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71222,(1),null);
var vec__71226 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71226,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71226,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__71345 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__71345) : devtools.munging.parse_fn_info_deep.call(null,G__71345));
})()));
}
} else {
return fn_info;
...
var G__71628 = (arity + (1));
var G__71629 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__71412){
var vec__71413 = p__71412;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71413,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71413,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__71418_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__71418_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__71419_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__71419_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___71662 = arguments.length;
var i__4737__auto___71663 = (0);
while(true){
if((i__4737__auto___71663 < len__4736__auto___71662)){
args__4742__auto__.push((arguments[i__4737__auto___71663]));

var G__71664 = (i__4737__auto___71663 + (1));
i__4737__auto___71663 = G__71664;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__71422){
var vec__71423 = p__71422;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71423,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq71420){
var G__71421 = cljs.core.first(seq71420);
var seq71420__$1 = cljs.core.next(seq71420);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__71421,seq71420__$1);
}));
...
var G__71426 = arg;
var G__71426__$1 = (((G__71426 instanceof cljs.core.Keyword))?G__71426.fqn:null);
switch (G__71426__$1) {
...
var map__71432 = options;
var map__71432__$1 = (((((!((map__71432 == null))))?(((((map__71432.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__71432.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__71432):map__71432);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71432__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71432__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71432__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71432__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__71433 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71433,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71433,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71433,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71433,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71433,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71433,(5),null);
...
var o__57990__auto__ = f;
return (o__57990__auto__["getBasis"]).call(o__57990__auto__);
});
/**
...
}catch (e71447){var _e__57997__auto__ = e71447;
...
var G__71727 = (obj[cljs.core.first(path)]);
var G__71728 = cljs.core.rest(path);
obj = G__71727;
path = G__71728;
continue;
} else {
...
var _STAR_ = (function (accum,p__71452){
var vec__71453 = p__71452;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71453,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71453,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__71462){
var vec__71464 = p__71462;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71464,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71464,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71464,(2),null);
...
var post_process = (function (p__71472){
var vec__71473 = p__71472;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71473,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71473,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__71470_SHARP_){
return (obj[cljs.core.first(p1__71470_SHARP_)]);
}),sorted_matches);
