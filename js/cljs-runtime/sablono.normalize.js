...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__72762){
var vec__72763 = p__72762;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72763,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72763,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__72769_SHARP_){
return (((p1__72769_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__72769_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__72773,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__72773;
}
});
...
var len__4736__auto___72866 = arguments.length;
var i__4737__auto___72867 = (0);
while(true){
if((i__4737__auto___72867 < len__4736__auto___72866)){
args__4742__auto__.push((arguments[i__4737__auto___72867]));

var G__72868 = (i__4737__auto___72867 + (1));
i__4737__auto___72867 = G__72868;
continue;
} else {
}
break;
...
var G__72779 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__72779,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__72779;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq72776){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq72776));
}));
...
var vec__72789 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__72793 = cljs.core.ffirst(matches);
var fexpr__72792 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__72792.cljs$core$IFn$_invoke$arity$1 ? fexpr__72792.cljs$core$IFn$_invoke$arity$1(G__72793) : fexpr__72792.call(null,G__72793));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72789,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72789,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__72785_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__72785_SHARP_))){
return p1__72785_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__72787_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__72787_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__72811){
var vec__72813 = p__72811;
var seq__72814 = cljs.core.seq(vec__72813);
var first__72815 = cljs.core.first(seq__72814);
var seq__72814__$1 = cljs.core.next(seq__72814);
var tag = first__72815;
var content = seq__72814__$1;
...
var vec__72835 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72835,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72835,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72835,(2),null);
