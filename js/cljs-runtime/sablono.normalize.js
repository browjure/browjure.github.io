...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__76627){
var vec__76629 = p__76627;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76629,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76629,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__76646_SHARP_){
return (((p1__76646_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__76646_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__76694,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__76694;
}
});
...
var len__4736__auto___76821 = arguments.length;
var i__4737__auto___76824 = (0);
while(true){
if((i__4737__auto___76824 < len__4736__auto___76821)){
args__4742__auto__.push((arguments[i__4737__auto___76824]));

var G__76828 = (i__4737__auto___76824 + (1));
i__4737__auto___76824 = G__76828;
continue;
} else {
}
break;
...
var G__76701 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__76701,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__76701;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq76700){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq76700));
}));
...
var vec__76706 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__76710 = cljs.core.ffirst(matches);
var fexpr__76709 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__76709.cljs$core$IFn$_invoke$arity$1 ? fexpr__76709.cljs$core$IFn$_invoke$arity$1(G__76710) : fexpr__76709.call(null,G__76710));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76706,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76706,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__76702_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__76702_SHARP_))){
return p1__76702_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__76704_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__76704_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__76730){
var vec__76731 = p__76730;
var seq__76732 = cljs.core.seq(vec__76731);
var first__76733 = cljs.core.first(seq__76732);
var seq__76732__$1 = cljs.core.next(seq__76732);
var tag = first__76733;
var content = seq__76732__$1;
...
var vec__76734 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76734,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76734,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76734,(2),null);
