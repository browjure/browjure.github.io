...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__125529){
var vec__125530 = p__125529;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125530,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125530,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__125541_SHARP_){
return (((p1__125541_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__125541_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__125558,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__125558;
}
});
...
var len__4736__auto___125635 = arguments.length;
var i__4737__auto___125636 = (0);
while(true){
if((i__4737__auto___125636 < len__4736__auto___125635)){
args__4742__auto__.push((arguments[i__4737__auto___125636]));

var G__125638 = (i__4737__auto___125636 + (1));
i__4737__auto___125636 = G__125638;
continue;
} else {
}
break;
...
var G__125566 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__125566,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__125566;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq125561){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq125561));
}));
...
var vec__125577 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__125581 = cljs.core.ffirst(matches);
var fexpr__125580 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__125580.cljs$core$IFn$_invoke$arity$1 ? fexpr__125580.cljs$core$IFn$_invoke$arity$1(G__125581) : fexpr__125580.call(null,G__125581));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125577,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125577,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__125574_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__125574_SHARP_))){
return p1__125574_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__125575_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__125575_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__125591){
var vec__125592 = p__125591;
var seq__125593 = cljs.core.seq(vec__125592);
var first__125594 = cljs.core.first(seq__125593);
var seq__125593__$1 = cljs.core.next(seq__125593);
var tag = first__125594;
var content = seq__125593__$1;
...
var vec__125599 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125599,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125599,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125599,(2),null);
