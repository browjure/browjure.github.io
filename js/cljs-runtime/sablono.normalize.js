...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__81545){
var vec__81546 = p__81545;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81546,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81546,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__81556_SHARP_){
return (((p1__81556_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__81556_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__81567,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__81567;
}
});
...
var len__4736__auto___81648 = arguments.length;
var i__4737__auto___81649 = (0);
while(true){
if((i__4737__auto___81649 < len__4736__auto___81648)){
args__4742__auto__.push((arguments[i__4737__auto___81649]));

var G__81650 = (i__4737__auto___81649 + (1));
i__4737__auto___81649 = G__81650;
continue;
} else {
}
break;
...
var G__81569 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__81569,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__81569;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq81568){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq81568));
}));
...
var vec__81583 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__81587 = cljs.core.ffirst(matches);
var fexpr__81586 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__81586.cljs$core$IFn$_invoke$arity$1 ? fexpr__81586.cljs$core$IFn$_invoke$arity$1(G__81587) : fexpr__81586.call(null,G__81587));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81583,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81583,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__81581_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__81581_SHARP_))){
return p1__81581_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__81582_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__81582_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__81613){
var vec__81614 = p__81613;
var seq__81615 = cljs.core.seq(vec__81614);
var first__81616 = cljs.core.first(seq__81615);
var seq__81615__$1 = cljs.core.next(seq__81615);
var tag = first__81616;
var content = seq__81615__$1;
...
var vec__81625 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81625,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81625,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81625,(2),null);
