...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__79475){
var vec__79478 = p__79475;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79478,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79478,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__79497_SHARP_){
return (((p1__79497_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__79497_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__79508,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__79508;
}
});
...
var len__4736__auto___79622 = arguments.length;
var i__4737__auto___79623 = (0);
while(true){
if((i__4737__auto___79623 < len__4736__auto___79622)){
args__4742__auto__.push((arguments[i__4737__auto___79623]));

var G__79624 = (i__4737__auto___79623 + (1));
i__4737__auto___79623 = G__79624;
continue;
} else {
}
break;
...
var G__79519 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__79519,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__79519;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq79510){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq79510));
}));
...
var vec__79553 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__79562 = cljs.core.ffirst(matches);
var fexpr__79560 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__79560.cljs$core$IFn$_invoke$arity$1 ? fexpr__79560.cljs$core$IFn$_invoke$arity$1(G__79562) : fexpr__79560.call(null,G__79562));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79553,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79553,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__79542_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__79542_SHARP_))){
return p1__79542_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__79544_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__79544_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__79585){
var vec__79588 = p__79585;
...
var tag = first__79590;
var content = seq__79589__$1;
...
var vec__79600 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79600,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79600,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79600,(2),null);
