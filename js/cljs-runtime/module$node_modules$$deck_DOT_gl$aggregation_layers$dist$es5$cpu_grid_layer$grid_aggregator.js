...
aggregationParams.gridOffset||(0,_gridAggregationUtils.getGridOffset)(attributes,cellSize);if(0>=aggregationParams.xOffset||0>=aggregationParams.yOffset){var JSCompiler_object_inline_gridHash_4467={};var JSCompiler_object_inline_gridOffset_4468=aggregationParams;var JSCompiler_object_inline_offsets_4469=void 0}else{cellSize=Math.ceil(props.width/aggregationParams.xOffset);attributes=Math.ceil(props.height/aggregationParams.yOffset);JSCompiler_temp={};yMax=(0,_core.createIterable)(data);data=yMax.objectInfo;
yMin=Array(3);yMax=_createForOfIteratorHelper(yMax.iterable);try{for(yMax.s();!(JSCompiler_object_inline_gridHash_4467=yMax.n()).done;){JSCompiler_object_inline_gridOffset_4468=JSCompiler_object_inline_gridHash_4467.value;data.index++;yMin[0]=positions[data.index*size];yMin[1]=positions[data.index*size+1];yMin[2]=3<=size?positions[data.index*size+2]:0;var _ref=_props$data?props.project(yMin):yMin,_ref2=(0,_slicedToArray2["default"])(_ref,2);JSCompiler_object_inline_offsets_4469=_ref2[0];var y$jscomp$0=
_ref2[1];if(Number.isFinite(JSCompiler_object_inline_offsets_4469)&&Number.isFinite(y$jscomp$0)){var yIndex=Math.floor((y$jscomp$0+numInstances[1])/aggregationParams.yOffset),xIndex=Math.floor((JSCompiler_object_inline_offsets_4469+numInstances[0])/aggregationParams.xOffset);if(!_props$data||0<=xIndex&&xIndex<cellSize&&0<=yIndex&&yIndex<attributes){var key="".concat(yIndex,"-").concat(xIndex);JSCompiler_temp[key]=JSCompiler_temp[key]||{count:0,points:[],lonIdx:xIndex,latIdx:yIndex};JSCompiler_temp[key].count+=
1;JSCompiler_temp[key].points.push({source:JSCompiler_object_inline_gridOffset_4468,index:data.index})}}}}catch(err){yMax.e(err)}finally{yMax.f()}JSCompiler_object_inline_gridHash_4467=JSCompiler_temp;JSCompiler_object_inline_gridOffset_4468=aggregationParams;JSCompiler_object_inline_offsets_4469=[-1*numInstances[0],-1*numInstances[1]]}_ref=JSCompiler_object_inline_gridHash_4467;_ref2=JSCompiler_object_inline_gridOffset_4468;y$jscomp$0=Array(Object.keys(_ref).length);yIndex=0;for(var key$jscomp$0 in _ref)key=
key$jscomp$0.split("-"),xIndex=parseInt(key[0],10),key=parseInt(key[1],10),props=yIndex++,y$jscomp$0[props]=Object.assign({index:props,position:[JSCompiler_object_inline_offsets_4469[0]+_ref2.xOffset*key,JSCompiler_object_inline_offsets_4469[1]+_ref2.yOffset*xIndex]},_ref[key$jscomp$0]);return{gridHash:JSCompiler_object_inline_gridHash_4467,gridOffset:JSCompiler_object_inline_gridOffset_4468,data:y$jscomp$0}};var _slicedToArray2=global(require("module$node_modules$$babel$runtime$helpers$slicedToArray")),
