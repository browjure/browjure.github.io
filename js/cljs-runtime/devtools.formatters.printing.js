...
var len__4736__auto___60325 = arguments.length;
var i__4737__auto___60326 = (0);
while(true){
if((i__4737__auto___60326 < len__4736__auto___60325)){
args__4742__auto__.push((arguments[i__4737__auto___60326]));

var G__60327 = (i__4737__auto___60326 + (1));
i__4737__auto___60326 = G__60327;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq60248){
var G__60249 = cljs.core.first(seq60248);
var seq60248__$1 = cljs.core.next(seq60248);
var G__60250 = cljs.core.first(seq60248__$1);
var seq60248__$2 = cljs.core.next(seq60248__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__60249,G__60250,seq60248__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__60268_SHARP_){
return (!((cljs.core.meta(p1__60268_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60279__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e60294){var _e__58832__auto__ = e60294;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e60296){var _e__58832__auto__ = e60296;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__60301 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__60302 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__60302);

try{var map__60306 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60306__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__60301);
}});
...
var temp__5751__auto___60377 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___60377)){
var managed_print_level_60378 = temp__5751__auto___60377;
var _STAR_print_level_STAR__orig_val__60316_60379 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__60317_60380 = managed_print_level_60378;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__60317_60380);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__60310_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__60310_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__60316_60379);
}} else {
job_fn();
}
