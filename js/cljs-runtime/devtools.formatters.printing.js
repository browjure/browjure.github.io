...
var len__4736__auto___74124 = arguments.length;
var i__4737__auto___74125 = (0);
while(true){
if((i__4737__auto___74125 < len__4736__auto___74124)){
args__4742__auto__.push((arguments[i__4737__auto___74125]));

var G__74130 = (i__4737__auto___74125 + (1));
i__4737__auto___74125 = G__74130;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq74024){
var G__74025 = cljs.core.first(seq74024);
var seq74024__$1 = cljs.core.next(seq74024);
var G__74026 = cljs.core.first(seq74024__$1);
var seq74024__$2 = cljs.core.next(seq74024__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__74025,G__74026,seq74024__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__74063_SHARP_){
return (!((cljs.core.meta(p1__74063_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74088__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e74096){var _e__57929__auto__ = e74096;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e74100){var _e__57929__auto__ = e74100;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__74105 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__74106 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__74106);

try{var map__74107 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74107__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__74105);
}});
...
var temp__5751__auto___74169 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___74169)){
var managed_print_level_74170 = temp__5751__auto___74169;
var _STAR_print_level_STAR__orig_val__74115_74171 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__74116_74172 = managed_print_level_74170;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__74116_74172);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__74114_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__74114_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__74115_74171);
}} else {
job_fn();
}
