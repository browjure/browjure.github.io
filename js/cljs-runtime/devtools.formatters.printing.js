...
var len__4736__auto___118221 = arguments.length;
var i__4737__auto___118222 = (0);
while(true){
if((i__4737__auto___118222 < len__4736__auto___118221)){
args__4742__auto__.push((arguments[i__4737__auto___118222]));

var G__118223 = (i__4737__auto___118222 + (1));
i__4737__auto___118222 = G__118223;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq118162){
var G__118163 = cljs.core.first(seq118162);
var seq118162__$1 = cljs.core.next(seq118162);
var G__118164 = cljs.core.first(seq118162__$1);
var seq118162__$2 = cljs.core.next(seq118162__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__118163,G__118164,seq118162__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__118187_SHARP_){
return (!((cljs.core.meta(p1__118187_SHARP_) == null)));
})))){
...
var map__118201 = opts;
var map__118201__$1 = (((((!((map__118201 == null))))?(((((map__118201.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__118201.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__118201):map__118201);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118201__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e118206){var _e__57929__auto__ = e118206;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e118208){var _e__57929__auto__ = e118208;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__118210 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__118211 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__118211);

try{var map__118212 = opts;
var map__118212__$1 = (((((!((map__118212 == null))))?(((((map__118212.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__118212.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__118212):map__118212);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118212__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__118210);
}});
...
var temp__5751__auto___118235 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___118235)){
var managed_print_level_118236 = temp__5751__auto___118235;
var _STAR_print_level_STAR__orig_val__118215_118237 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__118216_118238 = managed_print_level_118236;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__118216_118238);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__118214_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__118214_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__118215_118237);
}} else {
job_fn();
}
