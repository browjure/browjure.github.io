...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq60816){
var G__60817 = cljs.core.first(seq60816);
var seq60816__$1 = cljs.core.next(seq60816);
var G__60819 = cljs.core.first(seq60816__$1);
var seq60816__$2 = cljs.core.next(seq60816__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__60817,G__60819,seq60816__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__60841_SHARP_){
return (!((cljs.core.meta(p1__60841_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60851__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e60856){var _e__59883__auto__ = e60856;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e60859){var _e__59883__auto__ = e60859;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__60863 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__60864 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__60864);

try{var map__60865 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60865__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__60863);
}});
...
var temp__5751__auto___60901 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___60901)){
var managed_print_level_60902 = temp__5751__auto___60901;
var _STAR_print_level_STAR__orig_val__60870_60903 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__60871_60904 = managed_print_level_60902;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__60871_60904);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__60868_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__60868_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__60870_60903);
}} else {
job_fn();
}
