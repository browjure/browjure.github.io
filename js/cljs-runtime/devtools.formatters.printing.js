...
var len__4736__auto___60682 = arguments.length;
var i__4737__auto___60683 = (0);
while(true){
if((i__4737__auto___60683 < len__4736__auto___60682)){
args__4742__auto__.push((arguments[i__4737__auto___60683]));

var G__60684 = (i__4737__auto___60683 + (1));
i__4737__auto___60683 = G__60684;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq60617){
var G__60618 = cljs.core.first(seq60617);
var seq60617__$1 = cljs.core.next(seq60617);
var G__60619 = cljs.core.first(seq60617__$1);
var seq60617__$2 = cljs.core.next(seq60617__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__60618,G__60619,seq60617__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__60639_SHARP_){
return (!((cljs.core.meta(p1__60639_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60651__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e60656){var _e__59747__auto__ = e60656;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e60659){var _e__59747__auto__ = e60659;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__60666 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__60667 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__60667);

try{var map__60668 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60668__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__60666);
}});
...
var temp__5751__auto___60709 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___60709)){
var managed_print_level_60710 = temp__5751__auto___60709;
var _STAR_print_level_STAR__orig_val__60675_60711 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__60676_60712 = managed_print_level_60710;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__60676_60712);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__60671_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__60671_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__60675_60711);
}} else {
job_fn();
}
