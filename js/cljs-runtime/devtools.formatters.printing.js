...
var len__4736__auto___60747 = arguments.length;
var i__4737__auto___60759 = (0);
while(true){
if((i__4737__auto___60759 < len__4736__auto___60747)){
args__4742__auto__.push((arguments[i__4737__auto___60759]));

var G__60773 = (i__4737__auto___60759 + (1));
i__4737__auto___60759 = G__60773;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq60677){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__60678,G__60679,seq60677__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__60694_SHARP_){
return (!((cljs.core.meta(p1__60694_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60712__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e60718){var _e__59405__auto__ = e60718;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e60721){var _e__59405__auto__ = e60721;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__60731 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__60732 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__60732);

try{var map__60735 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60735__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__60731);
}});
...
var temp__5751__auto___60816 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___60816)){
var managed_print_level_60817 = temp__5751__auto___60816;
var _STAR_print_level_STAR__orig_val__60738_60818 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__60739_60819 = managed_print_level_60817;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__60739_60819);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__60737_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__60737_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__60738_60818);
}} else {
job_fn();
}
