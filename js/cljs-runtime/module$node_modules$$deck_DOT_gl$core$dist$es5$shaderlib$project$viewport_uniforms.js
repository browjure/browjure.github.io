...
[0,0,0],getMemoizedViewportUniforms=(0,exports["default"])(function(_ref2){var viewport=_ref2.viewport,devicePixelRatio=_ref2.devicePixelRatio,coordinateSystem=_ref2.coordinateSystem;var JSCompiler_object_inline_viewProjectionMatrix_6534=viewport.viewMatrixUncentered;var JSCompiler_object_inline_projectionCenter_6535=viewport.projectionMatrix;var viewMatrix=viewport.viewMatrix,viewProjectionMatrix=viewport.viewProjectionMatrix,projectionCenter=ZERO_VECTOR;var JSCompiler_object_inline_cameraPosCommon_6536=
viewport.cameraPosition;var _getOffsetOrigin=getOffsetOrigin(viewport,coordinateSystem,_ref2.coordinateOrigin);_ref2=_getOffsetOrigin.geospatialOrigin;var shaderCoordinateOrigin=_getOffsetOrigin.shaderCoordinateOrigin;_getOffsetOrigin.offsetMode&&(projectionCenter=viewport.projectPosition(_ref2||shaderCoordinateOrigin),JSCompiler_object_inline_cameraPosCommon_6536=[JSCompiler_object_inline_cameraPosCommon_6536[0]-projectionCenter[0],JSCompiler_object_inline_cameraPosCommon_6536[1]-projectionCenter[1],
JSCompiler_object_inline_cameraPosCommon_6536[2]-projectionCenter[2]],projectionCenter[3]=1,projectionCenter=vec4.transformMat4([],projectionCenter,viewProjectionMatrix),viewProjectionMatrix=mat4.multiply([],JSCompiler_object_inline_projectionCenter_6535,JSCompiler_object_inline_viewProjectionMatrix_6534||viewMatrix),viewProjectionMatrix=mat4.multiply([],viewProjectionMatrix,VECTOR_TO_POINT_MATRIX));JSCompiler_object_inline_viewProjectionMatrix_6534=viewProjectionMatrix;JSCompiler_object_inline_projectionCenter_6535=
projectionCenter;viewMatrix=viewport.getDistanceScales();devicePixelRatio={project_uCoordinateSystem:coordinateSystem,project_uProjectionMode:viewport.projectionMode,project_uCoordinateOrigin:shaderCoordinateOrigin,project_uCenter:JSCompiler_object_inline_projectionCenter_6535,project_uViewportSize:[viewport.width*devicePixelRatio,viewport.height*devicePixelRatio],project_uDevicePixelRatio:devicePixelRatio,project_uFocalDistance:viewport.focalDistance||1,project_uCommonUnitsPerMeter:viewMatrix.unitsPerMeter,
project_uCommonUnitsPerWorldUnit:viewMatrix.unitsPerMeter,project_uCommonUnitsPerWorldUnit2:DEFAULT_PIXELS_PER_UNIT2,project_uScale:viewport.scale,project_uViewProjectionMatrix:JSCompiler_object_inline_viewProjectionMatrix_6534,project_uCameraPosition:JSCompiler_object_inline_cameraPosCommon_6536};if(_ref2)switch(viewport=viewport.getDistanceScales(_ref2),coordinateSystem){case _constants.COORDINATE_SYSTEM.METER_OFFSETS:devicePixelRatio.project_uCommonUnitsPerWorldUnit=viewport.unitsPerMeter;devicePixelRatio.project_uCommonUnitsPerWorldUnit2=
