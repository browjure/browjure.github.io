...
(taoensso.timbre.appenders.core.println_appender.cljs$core$IFn$_invoke$arity$variadic = (function (p__80835){
var vec__80836 = p__80835;
var _opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80836,(0),null);
...
var map__80853 = data;
var map__80853__$1 = (((((!((map__80853 == null))))?(((((map__80853.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__80853.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__80853):map__80853);
var output_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80853__$1,new cljs.core.Keyword(null,"output_","output_",-36797880));
...
/** @this {Function} */
(taoensso.timbre.appenders.core.println_appender.cljs$lang$applyTo = (function (seq80831){
...
var args__4742__auto__ = [];
var len__4736__auto___80901 = arguments.length;
var i__4737__auto___80902 = (0);
while(true){
if((i__4737__auto___80902 < len__4736__auto___80901)){
args__4742__auto__.push((arguments[i__4737__auto___80902]));

var G__80903 = (i__4737__auto___80902 + (1));
i__4737__auto___80902 = G__80903;
continue;
} else {
}
break;
...
(taoensso.timbre.appenders.core.console_appender.cljs$core$IFn$_invoke$arity$variadic = (function (p__80864){
var vec__80865 = p__80864;
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80865,(0),null);
...
var or__4126__auto__ = (function (){var G__80873 = level;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__80873__$1)].join('')));
...
var output = (function (){var G__80892 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(data,new cljs.core.Keyword(null,"msg_","msg_",-1925147000),"",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"?err","?err",549653299),null], 0));
var fexpr__80891 = new cljs.core.Keyword(null,"output-fn","output-fn",1600951539).cljs$core$IFn$_invoke$arity$1(data);
return (fexpr__80891.cljs$core$IFn$_invoke$arity$1 ? fexpr__80891.cljs$core$IFn$_invoke$arity$1(G__80892) : fexpr__80891.call(null,G__80892));
})();
...
/** @this {Function} */
(taoensso.timbre.appenders.core.console_appender.cljs$lang$applyTo = (function (seq80863){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq80863));
}));
