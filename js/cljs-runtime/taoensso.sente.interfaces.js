...
var taoensso$sente$interfaces$IServerChan$sch_open_QMARK_$dyn_81512 = (function (sch){
...
return taoensso$sente$interfaces$IServerChan$sch_open_QMARK_$dyn_81512(sch);
}
});

var taoensso$sente$interfaces$IServerChan$sch_close_BANG_$dyn_81516 = (function (sch){
var x__4428__auto__ = (((sch == null))?null:sch);
...
return taoensso$sente$interfaces$IServerChan$sch_close_BANG_$dyn_81516(sch);
}
});

var taoensso$sente$interfaces$IServerChan$sch_send_BANG_$dyn_81521 = (function (sch,websocket_QMARK_,msg){
var x__4428__auto__ = (((sch == null))?null:sch);
...
return taoensso$sente$interfaces$IServerChan$sch_send_BANG_$dyn_81521(sch,websocket_QMARK_,msg);
}
});
...
var taoensso$sente$interfaces$IServerChanAdapter$ring_req__GT_server_ch_resp$dyn_81524 = (function (sch_adapter,ring_req,callbacks_map){
...
return taoensso$sente$interfaces$IServerChanAdapter$ring_req__GT_server_ch_resp$dyn_81524(sch_adapter,ring_req,callbacks_map);
}
});
...
var taoensso$sente$interfaces$IPacker$pack$dyn_81529 = (function (_,x){
...
return taoensso$sente$interfaces$IPacker$pack$dyn_81529(_,x);
}
});

var taoensso$sente$interfaces$IPacker$unpack$dyn_81530 = (function (_,x){
var x__4428__auto__ = (((_ == null))?null:_);
...
return taoensso$sente$interfaces$IPacker$unpack$dyn_81530(_,x);
}
});
