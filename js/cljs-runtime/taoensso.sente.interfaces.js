...
var taoensso$sente$interfaces$IServerChan$sch_open_QMARK_$dyn_80846 = (function (sch){
...
return taoensso$sente$interfaces$IServerChan$sch_open_QMARK_$dyn_80846(sch);
}
});

var taoensso$sente$interfaces$IServerChan$sch_close_BANG_$dyn_80851 = (function (sch){
var x__4428__auto__ = (((sch == null))?null:sch);
...
return taoensso$sente$interfaces$IServerChan$sch_close_BANG_$dyn_80851(sch);
}
});

var taoensso$sente$interfaces$IServerChan$sch_send_BANG_$dyn_80857 = (function (sch,websocket_QMARK_,msg){
var x__4428__auto__ = (((sch == null))?null:sch);
...
return taoensso$sente$interfaces$IServerChan$sch_send_BANG_$dyn_80857(sch,websocket_QMARK_,msg);
}
});
...
var taoensso$sente$interfaces$IServerChanAdapter$ring_req__GT_server_ch_resp$dyn_80862 = (function (sch_adapter,ring_req,callbacks_map){
...
return taoensso$sente$interfaces$IServerChanAdapter$ring_req__GT_server_ch_resp$dyn_80862(sch_adapter,ring_req,callbacks_map);
}
});
...
var taoensso$sente$interfaces$IPacker$pack$dyn_80868 = (function (_,x){
...
return taoensso$sente$interfaces$IPacker$pack$dyn_80868(_,x);
}
});

var taoensso$sente$interfaces$IPacker$unpack$dyn_80878 = (function (_,x){
var x__4428__auto__ = (((_ == null))?null:_);
...
return taoensso$sente$interfaces$IPacker$unpack$dyn_80878(_,x);
}
});
