...
var taoensso$sente$interfaces$IServerChan$sch_open_QMARK_$dyn_77820 = (function (sch){
...
return taoensso$sente$interfaces$IServerChan$sch_open_QMARK_$dyn_77820(sch);
}
});

var taoensso$sente$interfaces$IServerChan$sch_close_BANG_$dyn_77832 = (function (sch){
var x__4428__auto__ = (((sch == null))?null:sch);
...
return taoensso$sente$interfaces$IServerChan$sch_close_BANG_$dyn_77832(sch);
}
});

var taoensso$sente$interfaces$IServerChan$sch_send_BANG_$dyn_77837 = (function (sch,websocket_QMARK_,msg){
var x__4428__auto__ = (((sch == null))?null:sch);
...
return taoensso$sente$interfaces$IServerChan$sch_send_BANG_$dyn_77837(sch,websocket_QMARK_,msg);
}
});
...
var taoensso$sente$interfaces$IServerChanAdapter$ring_req__GT_server_ch_resp$dyn_77843 = (function (sch_adapter,ring_req,callbacks_map){
...
return taoensso$sente$interfaces$IServerChanAdapter$ring_req__GT_server_ch_resp$dyn_77843(sch_adapter,ring_req,callbacks_map);
}
});
...
var taoensso$sente$interfaces$IPacker$pack$dyn_77844 = (function (_,x){
...
return taoensso$sente$interfaces$IPacker$pack$dyn_77844(_,x);
}
});

var taoensso$sente$interfaces$IPacker$unpack$dyn_77845 = (function (_,x){
var x__4428__auto__ = (((_ == null))?null:_);
...
return taoensso$sente$interfaces$IPacker$unpack$dyn_77845(_,x);
}
});
