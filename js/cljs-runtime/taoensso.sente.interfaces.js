...
var taoensso$sente$interfaces$IServerChan$sch_open_QMARK_$dyn_83570 = (function (sch){
...
return taoensso$sente$interfaces$IServerChan$sch_open_QMARK_$dyn_83570(sch);
}
});

var taoensso$sente$interfaces$IServerChan$sch_close_BANG_$dyn_83571 = (function (sch){
var x__4428__auto__ = (((sch == null))?null:sch);
...
return taoensso$sente$interfaces$IServerChan$sch_close_BANG_$dyn_83571(sch);
}
});

var taoensso$sente$interfaces$IServerChan$sch_send_BANG_$dyn_83573 = (function (sch,websocket_QMARK_,msg){
var x__4428__auto__ = (((sch == null))?null:sch);
...
return taoensso$sente$interfaces$IServerChan$sch_send_BANG_$dyn_83573(sch,websocket_QMARK_,msg);
}
});
...
var taoensso$sente$interfaces$IServerChanAdapter$ring_req__GT_server_ch_resp$dyn_83576 = (function (sch_adapter,ring_req,callbacks_map){
...
return taoensso$sente$interfaces$IServerChanAdapter$ring_req__GT_server_ch_resp$dyn_83576(sch_adapter,ring_req,callbacks_map);
}
});
...
var taoensso$sente$interfaces$IPacker$pack$dyn_83586 = (function (_,x){
...
return taoensso$sente$interfaces$IPacker$pack$dyn_83586(_,x);
}
});

var taoensso$sente$interfaces$IPacker$unpack$dyn_83592 = (function (_,x){
var x__4428__auto__ = (((_ == null))?null:_);
...
return taoensso$sente$interfaces$IPacker$unpack$dyn_83592(_,x);
}
});
