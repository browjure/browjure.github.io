...
var G__71448 = x;
var G__71448__$1 = (((G__71448 == null))?null:cljs.core.meta(G__71448));
if((G__71448__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("sci.impl","op","sci.impl/op",950953978).cljs$core$IFn$_invoke$arity$1(G__71448__$1);
}
});
...
var map__71482 = cljs.core.meta(iobj);
...
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71482__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71482__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var map__71502_71585 = cljs.core.meta(node);
var map__71502_71586__$1 = (((((!((map__71502_71585 == null))))?(((((map__71502_71585.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__71502_71585.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__71502_71585):map__71502_71585);
var line_71587 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__71502_71586__$1,new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(ctx));
var column_71588 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__71502_71586__$1,new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"column","column",2078222095).cljs$core$IFn$_invoke$arity$1(ctx));
if(cljs.core.truth_((function (){var and__4115__auto__ = line_71587;
if(cljs.core.truth_(and__4115__auto__)){
return column_71588;
} else {
return and__4115__auto__;
...
var m_71589 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(ex_msg),(cljs.core.truth_(ex_msg)?" ":null),"[at ",(function (){var temp__5753__auto__ = cljs.core.deref(sci.impl.vars.current_file);
if(cljs.core.truth_(temp__5753__auto__)){
var v = temp__5753__auto__;
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(v),", "].join('');
} else {
...
})(),"line ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(line_71587),", column ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(column_71588),"]"].join('');
var new_exception_71590 = (function (){var d = cljs.core.ex_data(e);
return cljs.core.ex_info.cljs$core$IFn$_invoke$arity$3(m_71589,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("sci","error","sci/error",-979082803),new cljs.core.Keyword(null,"line","line",212345235),line_71587,new cljs.core.Keyword(null,"column","column",2078222095),column_71588,new cljs.core.Keyword(null,"message","message",-406056002),m_71589], null),d], 0)),e);
})();
throw new_exception_71590;
} else {
throw e;
}
}
...
var len__4736__auto___71592 = arguments.length;
var i__4737__auto___71593 = (0);
while(true){
if((i__4737__auto___71593 < len__4736__auto___71592)){
args__4742__auto__.push((arguments[i__4737__auto___71593]));

var G__71594 = (i__4737__auto___71593 + (1));
i__4737__auto___71593 = G__71594;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq71513){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__71514,G__71515,seq71513__$2);
}));
...
var G__71529 = cljs.core.namespace(sym);
switch (G__71529) {
case "clojure.core":
case "cljs.core":
...
return (new cljs.core.MapEntry((function (){var G__71543 = cljs.core.key(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__71543) : inner.call(null,G__71543));
})(),(function (){var G__71545 = cljs.core.val(form);
...
var run = cljs.core.cons(fst,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__71562_SHARP_){
return f(p1__71562_SHARP_);
}),cljs.core.next(s)));
return cljs.core.cons(run,(function (){var G__71563 = pred;
var G__71564 = (new cljs.core.LazySeq(null,(function (){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(run),s);
}),null,null));
return (sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2 ? sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2(G__71563,G__71564) : sci.impl.utils.split_when.call(null,G__71563,G__71564));
})());
} else {
return null;
}
