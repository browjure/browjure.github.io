...
var G__119319 = x;
var G__119319__$1 = (((G__119319 == null))?null:cljs.core.meta(G__119319));
if((G__119319__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("sci.impl","op","sci.impl/op",950953978).cljs$core$IFn$_invoke$arity$1(G__119319__$1);
}
});
...
var G__119351 = arguments.length;
switch (G__119351) {
case 0:
...
var G__119368 = arguments.length;
switch (G__119368) {
case 2:
...
var map__119379 = cljs.core.meta(iobj);
var map__119379__$1 = (((((!((map__119379 == null))))?(((((map__119379.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__119379.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__119379):map__119379);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__119379__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__119379__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var map__119405_119726 = cljs.core.meta(node);
var map__119405_119727__$1 = (((((!((map__119405_119726 == null))))?(((((map__119405_119726.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__119405_119726.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__119405_119726):map__119405_119726);
var line_119728 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__119405_119727__$1,new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(ctx));
var column_119729 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__119405_119727__$1,new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"column","column",2078222095).cljs$core$IFn$_invoke$arity$1(ctx));
if(cljs.core.truth_((function (){var and__4115__auto__ = line_119728;
if(cljs.core.truth_(and__4115__auto__)){
return column_119729;
} else {
return and__4115__auto__;
}
})())){
var m_119730 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(ex_msg),(cljs.core.truth_(ex_msg)?" ":null),"[at ",(function (){var temp__5753__auto__ = cljs.core.deref(sci.impl.vars.current_file);
if(cljs.core.truth_(temp__5753__auto__)){
var v = temp__5753__auto__;
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(v),", "].join('');
} else {
...
})(),"line ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(line_119728),", column ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(column_119729),"]"].join('');
var new_exception_119731 = (function (){var d = cljs.core.ex_data(e);
return cljs.core.ex_info.cljs$core$IFn$_invoke$arity$3(m_119730,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("sci","error","sci/error",-979082803),new cljs.core.Keyword(null,"line","line",212345235),line_119728,new cljs.core.Keyword(null,"column","column",2078222095),column_119729,new cljs.core.Keyword(null,"message","message",-406056002),m_119730], null),d], 0)),e);
})();
throw new_exception_119731;
} else {
throw e;
}
}
...
var len__4736__auto___119733 = arguments.length;
var i__4737__auto___119734 = (0);
while(true){
if((i__4737__auto___119734 < len__4736__auto___119733)){
args__4742__auto__.push((arguments[i__4737__auto___119734]));

var G__119735 = (i__4737__auto___119734 + (1));
i__4737__auto___119734 = G__119735;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq119481){
var G__119482 = cljs.core.first(seq119481);
var seq119481__$1 = cljs.core.next(seq119481);
var G__119483 = cljs.core.first(seq119481__$1);
var seq119481__$2 = cljs.core.next(seq119481__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__119482,G__119483,seq119481__$2);
}));
...
var G__119580 = cljs.core.namespace(sym);
switch (G__119580) {
case "clojure.core":
case "cljs.core":
...
return (new cljs.core.MapEntry((function (){var G__119588 = cljs.core.key(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__119588) : inner.call(null,G__119588));
})(),(function (){var G__119592 = cljs.core.val(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__119592) : inner.call(null,G__119592));
})(),null));
} else {
...
var run = cljs.core.cons(fst,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__119708_SHARP_){
return f(p1__119708_SHARP_);
}),cljs.core.next(s)));
return cljs.core.cons(run,(function (){var G__119709 = pred;
var G__119710 = (new cljs.core.LazySeq(null,(function (){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(run),s);
}),null,null));
return (sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2 ? sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2(G__119709,G__119710) : sci.impl.utils.split_when.call(null,G__119709,G__119710));
})());
} else {
return null;
}
