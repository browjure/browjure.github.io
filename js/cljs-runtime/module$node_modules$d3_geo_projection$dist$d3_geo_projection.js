...
y)};return forward}function sphereTop(x,i){return[x,i&1?89.999999:healpixParallel]}function sphereBottom(x,i){return[x,i&1?-89.999999:-healpixParallel]}function sphereNudge(d){return[.999999*d[0],d[1]]}function sphere$jscomp$0(step){var c=[].concat(d3Array.range(-180,180+step/2,step).map(sphereTop),d3Array.range(180,-180-step/2,-step).map(sphereBottom));return{type:"Polygon",coordinates:[180===step?c.map(sphereNudge):c]}}function hillRaw(K){function forward(lambda,phi){var t=1-sin(phi);if(t&&2>t){var theta=
...
return stream};return p$jscomp$0.scale(79.4187).parallel(45).clipAngle(179.999)};exports.geoHammerRetroazimuthalRaw=hammerRetroazimuthalRaw;exports.geoHealpix=function(){var H=4,m=d3Geo.geoProjectionMutator(healpixRaw),p=m(H),stream_=p.stream;p.lobes=function(_){return arguments.length?m(H=+_):H};p.stream=function(stream){var rotate=p.rotate(),rotateStream=stream_(stream),sphereStream=(p.rotate([0,0]),stream_(stream));p.rotate(rotate);rotateStream.sphere=function(){d3Geo.geoStream(sphere$jscomp$0(180/
H),sphereStream)};return rotateStream};return p.scale(239.75)};exports.geoHealpixRaw=healpixRaw;exports.geoHill=function(){var K=1,m=d3Geo.geoProjectionMutator(hillRaw),p=m(K);p.ratio=function(_){return arguments.length?m(K=+_):K};return p.scale(167.774).center([0,18.67])};exports.geoHillRaw=hillRaw;exports.geoHomolosine=function(){return d3Geo.geoProjection(homolosineRaw).scale(152.63)};exports.geoHomolosineRaw=homolosineRaw;exports.geoHufnagel=function(){var a=1,b=0,psiMax=45*radians,ratio=2,mutate=
d3Geo.geoProjectionMutator(hufnagelRaw),projection=mutate(a,b,psiMax,ratio);projection.a=function(_){return arguments.length?mutate(a=+_,b,psiMax,ratio):a};projection.b=function(_){return arguments.length?mutate(a,b=+_,psiMax,ratio):b};projection.psiMax=function(_){return arguments.length?mutate(a,b,psiMax=+_*radians,ratio):psiMax*degrees};projection.ratio=function(_){return arguments.length?mutate(a,b,psiMax,ratio=+_):ratio};return projection.scale(180.739)};exports.geoHufnagelRaw=hufnagelRaw;exports.geoHyperelliptical=
function(){var alpha=0,k=2.5,gamma=1.183136,m=d3Geo.geoProjectionMutator(hyperellipticalRaw),p=m(alpha,k,gamma);p.alpha=function(_){return arguments.length?m(alpha=+_,k,gamma):alpha};p.k=function(_){return arguments.length?m(alpha,k=+_,gamma):k};p.gamma=function(_){return arguments.length?m(alpha,k,gamma=+_):gamma};return p.scale(152.63)};exports.geoHyperellipticalRaw=hyperellipticalRaw;exports.geoInterrupt=interrupt;exports.geoInterruptedBoggs=function(){return interrupt(boggsRaw,lobes).scale(160.857)};
exports.geoInterruptedHomolosine=function(){return interrupt(homolosineRaw,lobes$1).scale(152.63)};exports.geoInterruptedMollweide=function(){return interrupt(mollweideRaw,lobes$2).scale(169.529)};exports.geoInterruptedMollweideHemispheres=function(){return interrupt(mollweideRaw,lobes$3).scale(169.529).rotate([20,0])};exports.geoInterruptedSinuMollweide=function(){return interrupt(sinuMollweideRaw,lobes$4,solve2d).rotate([-20,-55]).scale(164.263).center([0,-5.4036])};exports.geoInterruptedSinusoidal=
function(){return interrupt(sinusoidalRaw,lobes$5).scale(152.63).rotate([-20,0])};exports.geoKavrayskiy7=function(){return d3Geo.geoProjection(kavrayskiy7Raw).scale(158.837)};exports.geoKavrayskiy7Raw=kavrayskiy7Raw;exports.geoLagrange=function(){var n=.5,m=d3Geo.geoProjectionMutator(lagrangeRaw),p=m(n);p.spacing=function(_){return arguments.length?m(n=+_):n};return p.scale(124.75)};exports.geoLagrangeRaw=lagrangeRaw;exports.geoLarrivee=function(){return d3Geo.geoProjection(larriveeRaw).scale(97.2672)};
exports.geoLarriveeRaw=larriveeRaw;exports.geoLaskowski=function(){return d3Geo.geoProjection(laskowskiRaw).scale(139.98)};exports.geoLaskowskiRaw=laskowskiRaw;exports.geoLittrow=function(){return d3Geo.geoProjection(littrowRaw).scale(144.049).clipAngle(89.999)};exports.geoLittrowRaw=littrowRaw;exports.geoLoximuthal=function(){return parallel1(loximuthalRaw).parallel(40).scale(158.837)};exports.geoLoximuthalRaw=loximuthalRaw;exports.geoMiller=function(){return d3Geo.geoProjection(millerRaw).scale(108.318)};
exports.geoMillerRaw=millerRaw;exports.geoModifiedStereographic=modifiedStereographic;exports.geoModifiedStereographicRaw=modifiedStereographicRaw;exports.geoModifiedStereographicAlaska=function(){return modifiedStereographic(alaska,[152,-64]).scale(1400).center([-160.908,62.4864]).clipAngle(30).angle(7.8)};exports.geoModifiedStereographicGs48=function(){return modifiedStereographic(gs48,[95,-38]).scale(1E3).clipAngle(55).center([-96.5563,38.8675])};exports.geoModifiedStereographicGs50=function(){return modifiedStereographic(gs50,
