...
sci.impl.for_macro.expand_for = (function sci$impl$for_macro$expand_for(_,p__63025){
var vec__63026 = p__63025;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63026,(0),null);
var seq_exprs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63026,(1),null);
var body_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63026,(2),null);
sci.impl.for_macro.assert_args(seq_exprs,body_expr);

var to_groups = (function (seq_exprs__$1){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (groups,p__63031){
var vec__63032 = p__63031;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63032,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63032,(1),null);
...
var err = (function() { 
var G__63150__delegate = function (msg){
throw (new Error(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,msg)));
};
var G__63150 = function (var_args){
var msg = null;
if (arguments.length > 0) {
var G__63153__i = 0, G__63153__a = new Array(arguments.length -  0);
while (G__63153__i < G__63153__a.length) {G__63153__a[G__63153__i] = arguments[G__63153__i + 0]; ++G__63153__i;}
  msg = new cljs.core.IndexedSeq(G__63153__a,0,null);
} 
return G__63150__delegate.call(this,msg);};
G__63150.cljs$lang$maxFixedArity = 0;
G__63150.cljs$lang$applyTo = (function (arglist__63154){
var msg = cljs.core.seq(arglist__63154);
return G__63150__delegate(msg);
});
G__63150.cljs$core$IFn$_invoke$arity$variadic = G__63150__delegate;
return G__63150;
})()
;
var emit_bind = (function sci$impl$for_macro$expand_for_$_emit_bind(p__63036){
var vec__63040 = p__63036;
var seq__63041 = cljs.core.seq(vec__63040);
var first__63042 = cljs.core.first(seq__63041);
var seq__63041__$1 = cljs.core.next(seq__63041);
var vec__63043 = first__63042;
var seq__63044 = cljs.core.seq(vec__63043);
var first__63045 = cljs.core.first(seq__63044);
var seq__63044__$1 = cljs.core.next(seq__63044);
var bind = first__63045;
var first__63045__$1 = cljs.core.first(seq__63044__$1);
var seq__63044__$2 = cljs.core.next(seq__63044__$1);
var expr = first__63045__$1;
var mod_pairs = seq__63044__$2;
var vec__63046 = seq__63041__$1;
var vec__63049 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63046,(0),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63049,(0),null);
var next_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63049,(1),null);
var next_groups = vec__63046;
...
var do_mod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_mod(p__63053){
...
var vec__63057 = first__63056;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63057,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63057,(1),null);
var pair = vec__63057;
var etc = seq__63055__$1;
...
if(next_groups){
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","let","cljs.core/let",-308701135,null),null,(1),null)),(new cljs.core.List(null,cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__63018__auto__","iterys__63018__auto__",-1545428733,null),null,(1),null)),(new cljs.core.List(null,sci$impl$for_macro$expand_for_$_emit_bind(next_groups),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__63019__auto__","fs__63019__auto__",-3971943,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","seq","cljs.core/seq",-1649497689,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__63018__auto__","iterys__63018__auto__",-1545428733,null),null,(1),null)),(new cljs.core.List(null,next_expr,null,(1),null))))),null,(1),null))))),null,(1),null))], 0))))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"if","if",1181717262,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__63019__auto__","fs__63019__auto__",-3971943,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","concat","cljs.core/concat",-1133584918,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__63019__auto__","fs__63019__auto__",-3971943,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,giter,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,sci.impl.utils.allowed_recur,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null))], 0))));
} else {
...
var do_cmod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_cmod(p__63079){
var vec__63084 = p__63079;
var seq__63085 = cljs.core.seq(vec__63084);
var first__63086 = cljs.core.first(seq__63085);
var seq__63085__$1 = cljs.core.next(seq__63085);
var vec__63087 = first__63086;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63087,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63087,(1),null);
var pair = vec__63087;
var etc = seq__63085__$1;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(k,new cljs.core.Keyword(null,"let","let",-1282412701))){
