...
NO_TRANSITION_PROPS={transitionDuration:0},INERTIA_EASING=function(t){return 1-(1-t)*(1-t)},JSCompiler_object_inline_WHEEL_2643=["wheel"],JSCompiler_object_inline_PAN_2644=["panstart","panmove","panend"],JSCompiler_object_inline_PINCH_2645=["pinchstart","pinchmove","pinchend"],JSCompiler_object_inline_TRIPLE_PAN_2646=["tripanstart","tripanmove","tripanend"],JSCompiler_object_inline_DOUBLE_TAP_2647=["doubletap"],JSCompiler_object_inline_KEYBOARD_2648=["keydown"];require=function(){function Controller(ControllerState){var options=
...
!!this.onViewStateChange;this.toggleEvents(JSCompiler_object_inline_WHEEL_2643,isInteractive&&inertia);this.toggleEvents(JSCompiler_object_inline_PAN_2644,isInteractive&&(_props$dragPan||_props$dragRotate));this.toggleEvents(JSCompiler_object_inline_PINCH_2645,isInteractive&&(_props$touchZoom||_props$touchRotate));this.toggleEvents(JSCompiler_object_inline_TRIPLE_PAN_2646,isInteractive&&_props$touchRotate);this.toggleEvents(JSCompiler_object_inline_DOUBLE_TAP_2647,isInteractive&&_props$doubleClickZoo);
this.toggleEvents(JSCompiler_object_inline_KEYBOARD_2648,isInteractive&&props);this.scrollZoom=inertia;this.dragPan=_props$dragPan;this.dragRotate=_props$dragRotate;this.doubleClickZoom=_props$doubleClickZoo;this.touchZoom=_props$touchZoom;this.touchRotate=_props$touchRotate;this.keyboard=props}},{key:"updateTransition",value:function(){this.transitionManager.updateTransition()}},{key:"toggleEvents",value:function(eventNames,enabled){var _this2=this;this.eventManager&&eventNames.forEach(function(eventName){if(_this2._events[eventName]!==
