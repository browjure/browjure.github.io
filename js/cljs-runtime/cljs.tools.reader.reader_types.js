...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_61224 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_61224(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_61228 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_61228(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_61233 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_61233(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_61240 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_61240(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_61244 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_61244(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_61250 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_61250(reader);
}
});
...
var G__61345 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__61346 = s.append(c);
c = G__61345;
s = G__61346;
continue;
}
