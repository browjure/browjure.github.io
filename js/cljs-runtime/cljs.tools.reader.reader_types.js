...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_72359 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_72359(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_72361 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_72361(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_72363 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_72363(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_72369 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_72369(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_72373 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_72373(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_72380 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_72380(reader);
}
});
...
var G__72433 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__72434 = s.append(c);
c = G__72433;
s = G__72434;
continue;
}
