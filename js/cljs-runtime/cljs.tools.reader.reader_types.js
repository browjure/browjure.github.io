...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_61119 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_61119(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_61130 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_61130(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_61139 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_61139(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_61147 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_61147(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_61156 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_61156(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_61162 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_61162(reader);
}
});
...
var G__61304 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__61305 = s.append(c);
c = G__61304;
s = G__61305;
continue;
}
