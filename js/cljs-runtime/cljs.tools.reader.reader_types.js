...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_61060 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_61060(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_61067 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_61067(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_61071 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_61071(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_61076 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_61076(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_61080 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_61080(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_61083 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_61083(reader);
}
});
...
var G__61212 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__61213 = s.append(c);
c = G__61212;
s = G__61213;
continue;
}
