...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_60641 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_60641(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_60654 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_60654(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_60662 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_60662(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_60669 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_60669(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_60680 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_60680(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_60682 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_60682(reader);
}
});
...
var G__60828 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__60829 = s.append(c);
c = G__60828;
s = G__60829;
continue;
}
