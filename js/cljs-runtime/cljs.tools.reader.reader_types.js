...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_58819 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_58819(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_58823 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_58823(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_58826 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_58826(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_58828 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_58828(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_58831 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_58831(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_58832 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_58832(reader);
}
});
...
var G__58928 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__58929 = s.append(c);
c = G__58928;
s = G__58929;
continue;
}
