...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_118645 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_118645(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_118648 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_118648(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_118653 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_118653(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_118663 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_118663(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_118665 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_118665(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_118670 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_118670(reader);
}
});
...
var G__118488 = arguments.length;
switch (G__118488) {
case 1:
...
var G__118504 = arguments.length;
switch (G__118504) {
case 1:
...
var G__118755 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__118756 = s.append(c);
c = G__118755;
s = G__118756;
continue;
}
