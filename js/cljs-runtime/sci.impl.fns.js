...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__63299,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__63301 = p__63299;
...
var _m = map__63301__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63301__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63301__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63301__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63301__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__63417 = cljs.core.next(args__$1);
var G__63418 = cljs.core.next(params__$1);
var G__63419 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__63417;
params__$1 = G__63418;
ret = G__63419;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__63315 = ctx__$1;
var G__63316 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__63315,G__63316) : interpret.call(null,G__63315,G__63316));
...
var vec__63336 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63336,(0),null);
var vec__63339 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63336,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63339,(0),null);
var G__63441 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__63441;
continue;
} else {
var G__63442 = recur_val;
args = G__63442;
continue;
}
} else {
...
var G__63443__i = 0, G__63443__a = new Array(arguments.length -  0);
while (G__63443__i < G__63443__a.length) {G__63443__a[G__63443__i] = arguments[G__63443__i + 0]; ++G__63443__i;}
  args = new cljs.core.IndexedSeq(G__63443__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__63444){
...
var map__63350 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63350__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63350__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__63363){
...
var f = map__63364__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63364__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63364__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__63472__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__63472 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__63478__i = 0, G__63478__a = new Array(arguments.length -  0);
while (G__63478__i < G__63478__a.length) {G__63478__a[G__63478__i] = arguments[G__63478__i + 0]; ++G__63478__i;}
  args = new cljs.core.IndexedSeq(G__63478__a,0,null);
} 
return G__63472__delegate.call(this,args);};
G__63472.cljs$lang$maxFixedArity = 0;
G__63472.cljs$lang$applyTo = (function (arglist__63480){
var args = cljs.core.seq(arglist__63480);
return G__63472__delegate(args);
});
G__63472.cljs$core$IFn$_invoke$arity$variadic = G__63472__delegate;
return G__63472;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__63355_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__63355_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
...
while (G__63503__i < G__63503__a.length) {G__63503__a[G__63503__i] = arguments[G__63503__i + 0]; ++G__63503__i;}
  args = new cljs.core.IndexedSeq(G__63503__a,0,null);
} 
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__63357_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__63357_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
