...
this.eventManager!==_options$eventManager&&(this.eventManager=_options$eventManager,this._events={},this.toggleEvents(this.events,!0));this.toggleEvents(JSCompiler_object_inline_WHEEL_2590,_options$isInteractiv&&!!_options$scrollZoom);this.toggleEvents(JSCompiler_object_inline_PAN_2591,_options$isInteractiv&&!(!_options$dragPan&&!_options$dragRotate));this.toggleEvents(JSCompiler_object_inline_PINCH_2592,_options$isInteractiv&&!(!_options$touchZoom&&!_options$touchRotate));this.toggleEvents(JSCompiler_object_inline_TRIPLE_PAN_2593,
_options$isInteractiv&&!!_options$touchRotate);this.toggleEvents(JSCompiler_object_inline_DOUBLE_TAP_2594,_options$isInteractiv&&!!_options$doubleClickZ);this.toggleEvents(JSCompiler_object_inline_KEYBOARD_2595,_options$isInteractiv&&!!_options$keyboard);this.scrollZoom=_options$scrollZoom;this.dragPan=_options$dragPan;this.dragRotate=_options$dragRotate;this.doubleClickZoom=_options$doubleClickZ;this.touchZoom=_options$touchZoom;this.touchRotate=_options$touchRotate;this.keyboard=_options$keyboard}},
