...
sci.impl.interop.get_static_field = (function sci$impl$interop$get_static_field(p__75911){
var vec__75912 = p__75911;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75912,(0),null);
var field_name_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75912,(1),null);
...
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(p__75947,args){
var vec__75949 = p__75947;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75949,(0),null);
var method_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75949,(1),null);
...
var vec__75954 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(method_name__$1,/\./);
var field = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75954,(0),null);
var sub_method_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75954,(1),null);
...
sci.impl.interop.fully_qualify_class = (function sci$impl$interop$fully_qualify_class(p__75959,sym){
var map__75960 = p__75959;
var map__75960__$1 = (((((!((map__75960 == null))))?(((((map__75960.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__75960.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__75960):map__75960);
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75960__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var class__GT_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75960__$1,new cljs.core.Keyword(null,"class->opts","class->opts",2061906477));
...
sci.impl.interop.resolve_class_opts = (function sci$impl$interop$resolve_class_opts(p__75970,sym){
var map__75971 = p__75970;
...
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75971__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var class__GT_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75971__$1,new cljs.core.Keyword(null,"class->opts","class->opts",2061906477));
