...
e||self).vega={},e.vega,e.vega)}(this,function(e$jscomp$3,t$jscomp$2,n$jscomp$2){function u$jscomp$1(e,t){const $jscomp$async$this=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const n=yield $jscomp$async$this.sanitize(e,t),r=n.href;return n.localFile?$jscomp$async$this.file(r):$jscomp$async$this.http(r,t)})}function s$jscomp$0(e,n){const $jscomp$async$this=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){n=t$jscomp$2.extend({},$jscomp$async$this.options,
n);const u=$jscomp$async$this.fileAccess,s={href:null};let c,f,l;var p=o$jscomp$2.test(e.replace(i$jscomp$1,""));null!=e&&"string"==typeof e&&p||t$jscomp$2.error("Sanitize failure, invalid URI: "+t$jscomp$2.stringValue(e));p=r$jscomp$2.test(e);return(l=n.baseURL)&&!p&&(e.startsWith("/")||"/"===l[l.length-1]||(e="/"+e),e=l+e),f=(c=e.startsWith("file://"))||"file"===n.mode||"http"!==n.mode&&!p&&u,c?e=e.slice(7):e.startsWith("//")&&("file"===n.defaultProtocol?(e=e.slice(2),f=!0):e=(n.defaultProtocol||
"http")+":"+e),Object.defineProperty(s,"localFile",{value:!!f}),s.href=e,n.target&&(s.target=n.target+""),n.rel&&(s.rel=n.rel+""),"image"===n.context&&n.crossOrigin&&(s.crossOrigin=n.crossOrigin+""),s})}function c$jscomp$0(e$jscomp$0){return e$jscomp$0?t$jscomp$0=>new Promise((n,r)=>{e$jscomp$0.readFile(t$jscomp$0,(e,t)=>{e?r(e):n(t)})}):f$jscomp$0}function f$jscomp$0(){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){t$jscomp$2.error("No file system access.")})}function l$jscomp$0(e){return e?
function(n,r){const $jscomp$async$this=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){var o=t$jscomp$2.extend({},$jscomp$async$this.options.http,r);const i=r&&r.response;o=yield e(n,o);return o.ok?t$jscomp$2.isFunction(o[i])?o[i]():o.text():t$jscomp$2.error(o.status+""+o.statusText)})}:p$jscomp$0}function p$jscomp$0(){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){t$jscomp$2.error("No HTTP fetch method available.")})}function y(e$jscomp$0,t$jscomp$0){if(!e$jscomp$0||
!e$jscomp$0.length)return"unknown";const n=e$jscomp$0.length,r=g.length,o=g.map((e,t)=>t+1);for(let a,u,s=0,c=0;s<n;++s)for(u=t$jscomp$0?e$jscomp$0[s][t$jscomp$0]:e$jscomp$0[s],a=0;a<r;++a)if(o[a]&&null!=(i=u)&&i==i&&!g[a](u)&&(o[a]=0,++c,c===g.length))return"string";var i;return m[o.reduce((e,t)=>0===e?t:e,0)-1]}function v(e,t$jscomp$0){return t$jscomp$0.reduce((t,n)=>(t[n]=y(e,n),t),{})}function j(e$jscomp$0){return new Function("d","return {"+e$jscomp$0.map(function(e,t){return JSON.stringify(e)+
": d["+t+'] || ""'}).join(",")+"}")}function C(e$jscomp$0){var t=Object.create(null),n=[];return e$jscomp$0.forEach(function(e){for(var r in e)r in t||n.push(t[r]=r)}),n}function w(e,t){e+="";var r=e.length;return r<t?Array(t-r+1).join(0)+e:e}function A(e$jscomp$2){function r$jscomp$1(e,t$jscomp$0){function f(){if(s)return T;if(c)return c=!1,b;var t,r,o=a;if(34===e.charCodeAt(o)){for(;a++<i&&34!==e.charCodeAt(a)||34===e.charCodeAt(++a););return(t=a)>=i?s=!0:10===(r=e.charCodeAt(a++))?c=!0:13===r&&
(c=!0,10===e.charCodeAt(a)&&++a),e.slice(o+1,t-1).replace(/""/g,'"')}for(;a<i;){if(10===(r=e.charCodeAt(t=a++)))c=!0;else if(13===r)c=!0,10===e.charCodeAt(a)&&++a;else if(r!==n$jscomp$1)continue;return e.slice(o,t)}return s=!0,e.slice(o,i)}var r$jscomp$0,o$jscomp$0=[],i=e.length,a=0,u=0,s=0>=i,c=!1;10===e.charCodeAt(i-1)&&--i;for(13===e.charCodeAt(i-1)&&--i;(r$jscomp$0=f())!==T;){for(var l=[];r$jscomp$0!==b&&r$jscomp$0!==T;)l.push(r$jscomp$0),r$jscomp$0=f();t$jscomp$0&&null==(l=t$jscomp$0(l,u++))||
