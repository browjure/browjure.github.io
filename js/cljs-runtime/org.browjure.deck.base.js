...
(org.browjure.deck.base.set_tooltip.cljs$core$IFn$_invoke$arity$2 = (function (p__86538,label){
var vec__86539 = p__86538;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86539,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86539,(1),null);
...
(org.browjure.deck.base.set_tooltip.cljs$core$IFn$_invoke$arity$3 = (function (p__86543,label,p__86544){
var vec__86545 = p__86543;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86545,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86545,(1),null);
var map__86548 = p__86544;
var map__86548__$1 = (((((!((map__86548 == null))))?(((((map__86548.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__86548.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__86548):map__86548);
var font_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__86548__$1,new cljs.core.Keyword(null,"font-color","font-color",-2019660285),"white");
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__86553_SHARP_,p2__86554_SHARP_){
return (p1__86553_SHARP_[p2__86554_SHARP_]);
...
org.browjure.deck.base.set_hiccup_tooltip = (function org$browjure$deck$base$set_hiccup_tooltip(p__86556,hiccup){
var vec__86557 = p__86556;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86557,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86557,(1),null);
var tooltip = document.getElementById("tooltip");
var el = (cljs.core.truth_(tooltip)?tooltip:(function (){var new_el = document.createElement("div");
new_el.setAttribute("id","tooltip");
...
var uses_functions_QMARK_ = cljs.core.some((function (p__86569){
var vec__86570 = p__86569;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86570,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86570,(1),null);
return cognitect.transit.tagged_value_QMARK_(v);
}),layer_props);
if(cljs.core.truth_(uses_functions_QMARK_)){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(org.browjure.deck.base.active_layers,cljs.core.assoc,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(layer_props),cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var G__86576 = new cljs.core.Keyword(null,"layer-type","layer-type",816560917).cljs$core$IFn$_invoke$arity$1(layer_props);
return (org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1 ? org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1(G__86576) : org.browjure.deck.layers.key__GT_class.call(null,G__86576));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(org.browjure.deck.base.active_layers,cljs.core.assoc,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(layer_props),cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var G__86577 = new cljs.core.Keyword(null,"layer-type","layer-type",816560917).cljs$core$IFn$_invoke$arity$1(layer_props);
return (org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1 ? org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1(G__86577) : org.browjure.deck.layers.key__GT_class.call(null,G__86577));
...
org.browjure.deck.base.handler = (function org$browjure$deck$base$handler(p__86578){
var map__86579 = p__86578;
var map__86579__$1 = (((((!((map__86579 == null))))?(((((map__86579.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__86579.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__86579):map__86579);
var command = map__86579__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86579__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86579__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var payload = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86579__$1,new cljs.core.Keyword(null,"payload","payload",-383036092));
console.log("deck handler command: ",command);

var G__86583 = type;
var G__86583__$1 = (((G__86583 instanceof cljs.core.Keyword))?G__86583.fqn:null);
switch (G__86583__$1) {
case "mapbox-token":
...
var fp64 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86594__$1,new cljs.core.Keyword(null,"fp64","fp64",1314988535));
var filter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86594__$1,new cljs.core.Keyword(null,"filter-size","filter-size",-437273305));
return (new module$node_modules$$deck_DOT_gl$extensions$dist$es5$index.DataFilterExtension(({"filterSize": filter_size, "fp64": fp64})));
...
var compiled_layer_props = cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__86630){
var vec__86635 = p__86630;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86635,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86635,(1),null);
if(cljs.core.truth_(cognitect.transit.tagged_value_QMARK_(v))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","comp","cljs.core/comp",-2137591872,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol("cljs.core","clj->js","cljs.core/clj->js",-1490083117,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,(v["rep"]),null,(1),null))], 0))))], 0)),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"bindings","bindings",1271397192),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Symbol("js","console.log","js/console.log",-2005248266,null),console.log,new cljs.core.Symbol("js","document","js/document",311343521,null),document,new cljs.core.Symbol(null,"data-filter","data-filter",819088047,null),(function (p__86640){
var map__86641 = p__86640;
var map__86641__$1 = (((((!((map__86641 == null))))?(((((map__86641.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__86641.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__86641):map__86641);
var fp64 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86641__$1,new cljs.core.Keyword(null,"fp64","fp64",1314988535));
var filter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86641__$1,new cljs.core.Keyword(null,"filter-size","filter-size",-437273305));
return (new module$node_modules$$deck_DOT_gl$extensions$dist$es5$index.DataFilterExtension(({"filterSize": filter_size, "fp64": fp64})));
...
var uses_functions_QMARK_ = cljs.core.some((function (p__86645){
var vec__86646 = p__86645;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86646,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86646,(1),null);
return cognitect.transit.tagged_value_QMARK_(v);
}),layer_props);
if(cljs.core.truth_(uses_functions_QMARK_)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var G__86650 = new cljs.core.Keyword(null,"layer-type","layer-type",816560917).cljs$core$IFn$_invoke$arity$1(layer_props);
return (org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1 ? org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1(G__86650) : org.browjure.deck.layers.key__GT_class.call(null,G__86650));
})(),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"geo-json-layer","geo-json-layer",1279697285),null], null), null),new cljs.core.Keyword(null,"layer-type","layer-type",816560917).cljs$core$IFn$_invoke$arity$1(layer_props)))?cljs_bean.core.__GT_js(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([layer_props,compiled_layer_props], 0))):org.browjure.deck.base.assoc_cljs_data(cljs_bean.core.__GT_js(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([layer_props,compiled_layer_props], 0))),new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(layer_props)))], null));
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var G__86653 = new cljs.core.Keyword(null,"layer-type","layer-type",816560917).cljs$core$IFn$_invoke$arity$1(layer_props);
return (org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1 ? org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1(G__86653) : org.browjure.deck.layers.key__GT_class.call(null,G__86653));
})(),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs_bean.core.__GT_js(layer_props)], null));
}
});
org.browjure.deck.base.embed_component = (function org$browjure$deck$base$embed_component(var_args){
var args__4742__auto__ = [];
var len__4736__auto___87084 = arguments.length;
var i__4737__auto___87085 = (0);
while(true){
if((i__4737__auto___87085 < len__4736__auto___87084)){
args__4742__auto__.push((arguments[i__4737__auto___87085]));

var G__87086 = (i__4737__auto___87085 + (1));
i__4737__auto___87085 = G__87086;
continue;
} else {
}
break;
...
/** @this {Function} */
(org.browjure.deck.base.embed_component.cljs$lang$applyTo = (function (seq86655){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq86655));
}));


org.browjure.deck.base.deck_component = (function (){var G__86668 = (function org$browjure$deck$base$deck_component(props__73452__auto__,maybe_ref__73453__auto__){
var vec__86669 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [helix.core.extract_cljs_props(props__73452__auto__),maybe_ref__73453__auto__], null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86669,(0),null);
...
var dep_values = cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__86674){
var vec__86676 = p__86674;
var dep_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86676,(0),null);
var dep_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86676,(1),null);
...
var view_state = (function (){var G__86679 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"view-state","view-state",-976675614)], null);
return (use_path_sub.cljs$core$IFn$_invoke$arity$1 ? use_path_sub.cljs$core$IFn$_invoke$arity$1(G__86679) : use_path_sub.call(null,G__86679));
})();
var map__86672 = props;
var map__86672__$1 = (((((!((map__86672 == null))))?(((((map__86672.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__86672.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__86672):map__86672);
var data__GT_layers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86672__$1,new cljs.core.Keyword("deck","data->layers","deck/data->layers",-2136602585));
...
return helix.core.get_react().createElement("div",helix.impl.props.merge_obj((function (){var obj87063 = ({"key":["deck",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props))].join(''),"ref":(function (c){
if(cljs.core.truth_(c)){
...
})(),new cljs.core.Keyword(null,"layers","layers",1944875032),cljs.core.to_array(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__87064){
var vec__87067 = p__87064;
var layer_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__87067,(0),null);
var layers = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__87067,(1),null);
...
if(goog.DEBUG === true){
var G__87077 = G__86668;
goog.object.set(G__87077,"displayName","org.browjure.deck.base/deck-component");
