...
(org.browjure.deck.base.set_tooltip.cljs$core$IFn$_invoke$arity$2 = (function (p__83786,label){
var vec__83787 = p__83786;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83787,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83787,(1),null);
...
(org.browjure.deck.base.set_tooltip.cljs$core$IFn$_invoke$arity$3 = (function (p__83793,label,p__83794){
var vec__83795 = p__83793;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83795,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83795,(1),null);
var map__83798 = p__83794;
var map__83798__$1 = (((((!((map__83798 == null))))?(((((map__83798.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__83798.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__83798):map__83798);
var font_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__83798__$1,new cljs.core.Keyword(null,"font-color","font-color",-2019660285),"white");
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__83808_SHARP_,p2__83809_SHARP_){
return (p1__83808_SHARP_[p2__83809_SHARP_]);
...
org.browjure.deck.base.set_hiccup_tooltip = (function org$browjure$deck$base$set_hiccup_tooltip(p__83813,hiccup){
var vec__83814 = p__83813;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83814,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83814,(1),null);
var tooltip = document.getElementById("tooltip");
var el = (cljs.core.truth_(tooltip)?tooltip:(function (){var new_el = document.createElement("div");
new_el.setAttribute("id","tooltip");
...
var uses_functions_QMARK_ = cljs.core.some((function (p__83830){
var vec__83831 = p__83830;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83831,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83831,(1),null);
return cognitect.transit.tagged_value_QMARK_(v);
}),layer_props);
if(cljs.core.truth_(uses_functions_QMARK_)){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(org.browjure.deck.base.active_layers,cljs.core.assoc,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(layer_props),cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var G__83834 = new cljs.core.Keyword(null,"layer-type","layer-type",816560917).cljs$core$IFn$_invoke$arity$1(layer_props);
return (org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1 ? org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1(G__83834) : org.browjure.deck.layers.key__GT_class.call(null,G__83834));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(org.browjure.deck.base.active_layers,cljs.core.assoc,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(layer_props),cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var G__83839 = new cljs.core.Keyword(null,"layer-type","layer-type",816560917).cljs$core$IFn$_invoke$arity$1(layer_props);
return (org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1 ? org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1(G__83839) : org.browjure.deck.layers.key__GT_class.call(null,G__83839));
...
org.browjure.deck.base.handler = (function org$browjure$deck$base$handler(p__83843){
var map__83845 = p__83843;
var map__83845__$1 = (((((!((map__83845 == null))))?(((((map__83845.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__83845.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__83845):map__83845);
var command = map__83845__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83845__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83845__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var payload = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83845__$1,new cljs.core.Keyword(null,"payload","payload",-383036092));
console.log("deck handler command: ",command);

var G__83848 = type;
var G__83848__$1 = (((G__83848 instanceof cljs.core.Keyword))?G__83848.fqn:null);
switch (G__83848__$1) {
case "mapbox-token":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__83848__$1)].join('')));

}
});
org.browjure.deck.base.compile = (function org$browjure$deck$base$compile(form){
return sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([form], 0)),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"bindings","bindings",1271397192),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Symbol("js","console.log","js/console.log",-2005248266,null),console.log,new cljs.core.Symbol("js","document","js/document",311343521,null),document,new cljs.core.Symbol(null,"set-tooltip","set-tooltip",-550723715,null),org.browjure.deck.base.set_tooltip,new cljs.core.Symbol(null,"data-filter","data-filter",819088047,null),(function (p__83853){
var map__83854 = p__83853;
var map__83854__$1 = (((((!((map__83854 == null))))?(((((map__83854.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__83854.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__83854):map__83854);
var fp64 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83854__$1,new cljs.core.Keyword(null,"fp64","fp64",1314988535));
var filter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83854__$1,new cljs.core.Keyword(null,"filter-size","filter-size",-437273305));
return (new module$node_modules$$deck_DOT_gl$extensions$dist$es5$index.DataFilterExtension(({"filterSize": filter_size, "fp64": fp64})));
...
var compiled_layer_props = cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__83863){
var vec__83864 = p__83863;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83864,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83864,(1),null);
if(cljs.core.truth_(cognitect.transit.tagged_value_QMARK_(v))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","comp","cljs.core/comp",-2137591872,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol("cljs.core","clj->js","cljs.core/clj->js",-1490083117,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,(v["rep"]),null,(1),null))], 0))))], 0)),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"bindings","bindings",1271397192),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Symbol("js","console.log","js/console.log",-2005248266,null),console.log,new cljs.core.Symbol("js","document","js/document",311343521,null),document,new cljs.core.Symbol(null,"data-filter","data-filter",819088047,null),(function (p__83867){
var map__83868 = p__83867;
var map__83868__$1 = (((((!((map__83868 == null))))?(((((map__83868.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__83868.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__83868):map__83868);
var fp64 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83868__$1,new cljs.core.Keyword(null,"fp64","fp64",1314988535));
var filter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83868__$1,new cljs.core.Keyword(null,"filter-size","filter-size",-437273305));
return (new module$node_modules$$deck_DOT_gl$extensions$dist$es5$index.DataFilterExtension(({"filterSize": filter_size, "fp64": fp64})));
...
var uses_functions_QMARK_ = cljs.core.some((function (p__83872){
var vec__83873 = p__83872;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83873,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83873,(1),null);
return cognitect.transit.tagged_value_QMARK_(v);
}),layer_props);
if(cljs.core.truth_(uses_functions_QMARK_)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var G__83878 = new cljs.core.Keyword(null,"layer-type","layer-type",816560917).cljs$core$IFn$_invoke$arity$1(layer_props);
return (org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1 ? org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1(G__83878) : org.browjure.deck.layers.key__GT_class.call(null,G__83878));
})(),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"geo-json-layer","geo-json-layer",1279697285),null], null), null),new cljs.core.Keyword(null,"layer-type","layer-type",816560917).cljs$core$IFn$_invoke$arity$1(layer_props)))?cljs_bean.core.__GT_js(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([layer_props,compiled_layer_props], 0))):org.browjure.deck.base.assoc_cljs_data(cljs_bean.core.__GT_js(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([layer_props,compiled_layer_props], 0))),new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(layer_props)))], null));
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var G__83880 = new cljs.core.Keyword(null,"layer-type","layer-type",816560917).cljs$core$IFn$_invoke$arity$1(layer_props);
return (org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1 ? org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1(G__83880) : org.browjure.deck.layers.key__GT_class.call(null,G__83880));
})(),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs_bean.core.__GT_js(layer_props)], null));
}
});
org.browjure.deck.base.embed_component = (function org$browjure$deck$base$embed_component(var_args){
var args__4742__auto__ = [];
var len__4736__auto___85516 = arguments.length;
var i__4737__auto___85517 = (0);
while(true){
if((i__4737__auto___85517 < len__4736__auto___85516)){
args__4742__auto__.push((arguments[i__4737__auto___85517]));

var G__85518 = (i__4737__auto___85517 + (1));
i__4737__auto___85517 = G__85518;
continue;
} else {
}
break;
...
/** @this {Function} */
(org.browjure.deck.base.embed_component.cljs$lang$applyTo = (function (seq83882){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq83882));
}));


org.browjure.deck.base.deck_component = (function (){var G__83904 = (function org$browjure$deck$base$deck_component(props__58876__auto__,maybe_ref__58877__auto__){
var vec__83908 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [helix.core.extract_cljs_props(props__58876__auto__),maybe_ref__58877__auto__], null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83908,(0),null);
...
var dep_values = cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__83912){
var vec__83913 = p__83912;
var dep_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83913,(0),null);
var dep_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83913,(1),null);
...
var view_state = (function (){var G__83916 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"view-state","view-state",-976675614)], null);
return (use_path_sub.cljs$core$IFn$_invoke$arity$1 ? use_path_sub.cljs$core$IFn$_invoke$arity$1(G__83916) : use_path_sub.call(null,G__83916));
})();
var map__83911 = props;
var map__83911__$1 = (((((!((map__83911 == null))))?(((((map__83911.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__83911.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__83911):map__83911);
var data__GT_layers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83911__$1,new cljs.core.Keyword("deck","data->layers","deck/data->layers",-2136602585));
...
return helix.core.get_react().createElement("div",helix.impl.props.merge_obj((function (){var obj85508 = ({"key":["deck",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props))].join(''),"ref":(function (c){
if(cljs.core.truth_(c)){
...
})(),new cljs.core.Keyword(null,"layers","layers",1944875032),cljs.core.to_array(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__85509){
var vec__85510 = p__85509;
var layer_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85510,(0),null);
var layers = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85510,(1),null);
...
if(goog.DEBUG === true){
var G__85513 = G__83904;
goog.object.set(G__85513,"displayName","org.browjure.deck.base/deck-component");
