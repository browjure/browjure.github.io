...
(org.browjure.deck.base.set_tooltip.cljs$core$IFn$_invoke$arity$2 = (function (p__80635,label){
var vec__80636 = p__80635;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80636,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80636,(1),null);
...
(org.browjure.deck.base.set_tooltip.cljs$core$IFn$_invoke$arity$3 = (function (p__80639,label,p__80640){
var vec__80641 = p__80639;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80641,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80641,(1),null);
var map__80644 = p__80640;
...
var font_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__80644__$1,new cljs.core.Keyword(null,"font-color","font-color",-2019660285),"white");
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__80648_SHARP_,p2__80649_SHARP_){
return (p1__80648_SHARP_[p2__80649_SHARP_]);
...
org.browjure.deck.base.set_hiccup_tooltip = (function org$browjure$deck$base$set_hiccup_tooltip(p__80656,hiccup){
var vec__80657 = p__80656;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80657,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80657,(1),null);
var tooltip = document.getElementById("tooltip");
var el = (cljs.core.truth_(tooltip)?tooltip:(function (){var new_el = document.createElement("div");
new_el.setAttribute("id","tooltip");
...
var fp64 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80667__$1,new cljs.core.Keyword(null,"fp64","fp64",1314988535));
var filter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80667__$1,new cljs.core.Keyword(null,"filter-size","filter-size",-437273305));
...
var uses_functions_QMARK_ = cljs.core.some((function (p__80671){
var vec__80672 = p__80671;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80672,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80672,(1),null);
return cognitect.transit.tagged_value_QMARK_(v);
}),layer_props);
if(cljs.core.truth_(uses_functions_QMARK_)){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(org.browjure.deck.base.active_layers,cljs.core.assoc,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(layer_props),cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var G__80675 = new cljs.core.Keyword(null,"layer-type","layer-type",816560917).cljs$core$IFn$_invoke$arity$1(layer_props);
return (org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1 ? org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1(G__80675) : org.browjure.deck.layers.key__GT_class.call(null,G__80675));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(org.browjure.deck.base.active_layers,cljs.core.assoc,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(layer_props),cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var G__80678 = new cljs.core.Keyword(null,"layer-type","layer-type",816560917).cljs$core$IFn$_invoke$arity$1(layer_props);
return (org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1 ? org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1(G__80678) : org.browjure.deck.layers.key__GT_class.call(null,G__80678));
...
org.browjure.deck.base.handler = (function org$browjure$deck$base$handler(p__80685){
...
var command = map__80686__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80686__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80686__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var payload = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80686__$1,new cljs.core.Keyword(null,"payload","payload",-383036092));
console.log("deck handler command: ",command);

var G__80688 = type;
var G__80688__$1 = (((G__80688 instanceof cljs.core.Keyword))?G__80688.fqn:null);
switch (G__80688__$1) {
case "mapbox-token":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__80688__$1)].join('')));

}
});
org.browjure.deck.base.compile = (function org$browjure$deck$base$compile(form){
return sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([form], 0)),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"bindings","bindings",1271397192),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Symbol("js","console.log","js/console.log",-2005248266,null),console.log,new cljs.core.Symbol("js","document","js/document",311343521,null),document,new cljs.core.Symbol(null,"set-tooltip","set-tooltip",-550723715,null),org.browjure.deck.base.set_tooltip,new cljs.core.Symbol(null,"data-filter","data-filter",819088047,null),(function (p__80689){
var map__80690 = p__80689;
var map__80690__$1 = (((((!((map__80690 == null))))?(((((map__80690.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__80690.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__80690):map__80690);
var fp64 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80690__$1,new cljs.core.Keyword(null,"fp64","fp64",1314988535));
var filter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80690__$1,new cljs.core.Keyword(null,"filter-size","filter-size",-437273305));
return (new module$node_modules$$deck_DOT_gl$extensions$dist$es5$index.DataFilterExtension(({"filterSize": filter_size, "fp64": fp64})));
...
var compiled_layer_props = cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__80695){
var vec__80696 = p__80695;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80696,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80696,(1),null);
if(cljs.core.truth_(cognitect.transit.tagged_value_QMARK_(v))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","comp","cljs.core/comp",-2137591872,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol("cljs.core","clj->js","cljs.core/clj->js",-1490083117,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,(v["rep"]),null,(1),null))], 0))))], 0)),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"bindings","bindings",1271397192),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Symbol("js","console.log","js/console.log",-2005248266,null),console.log,new cljs.core.Symbol("js","document","js/document",311343521,null),document,new cljs.core.Symbol(null,"data-filter","data-filter",819088047,null),(function (p__80712){
var map__80713 = p__80712;
...
var fp64 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80713__$1,new cljs.core.Keyword(null,"fp64","fp64",1314988535));
var filter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80713__$1,new cljs.core.Keyword(null,"filter-size","filter-size",-437273305));
return (new module$node_modules$$deck_DOT_gl$extensions$dist$es5$index.DataFilterExtension(({"filterSize": filter_size, "fp64": fp64})));
...
var uses_functions_QMARK_ = cljs.core.some((function (p__80723){
var vec__80724 = p__80723;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80724,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80724,(1),null);
return cognitect.transit.tagged_value_QMARK_(v);
}),layer_props);
if(cljs.core.truth_(uses_functions_QMARK_)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var G__80728 = new cljs.core.Keyword(null,"layer-type","layer-type",816560917).cljs$core$IFn$_invoke$arity$1(layer_props);
return (org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1 ? org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1(G__80728) : org.browjure.deck.layers.key__GT_class.call(null,G__80728));
})(),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"geo-json-layer","geo-json-layer",1279697285),null], null), null),new cljs.core.Keyword(null,"layer-type","layer-type",816560917).cljs$core$IFn$_invoke$arity$1(layer_props)))?cljs_bean.core.__GT_js(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([layer_props,compiled_layer_props], 0))):org.browjure.deck.base.assoc_cljs_data(cljs_bean.core.__GT_js(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([layer_props,compiled_layer_props], 0))),new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(layer_props)))], null));
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var G__80729 = new cljs.core.Keyword(null,"layer-type","layer-type",816560917).cljs$core$IFn$_invoke$arity$1(layer_props);
return (org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1 ? org.browjure.deck.layers.key__GT_class.cljs$core$IFn$_invoke$arity$1(G__80729) : org.browjure.deck.layers.key__GT_class.call(null,G__80729));
})(),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs_bean.core.__GT_js(layer_props)], null));
}
});
...
/** @this {Function} */
(org.browjure.deck.base.embed_component.cljs$lang$applyTo = (function (seq80733){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq80733));
}));


org.browjure.deck.base.deck_component = (function (){var G__80748 = (function org$browjure$deck$base$deck_component(props__67027__auto__,maybe_ref__67028__auto__){
var vec__80752 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [helix.core.extract_cljs_props(props__67027__auto__),maybe_ref__67028__auto__], null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80752,(0),null);
...
var dep_values = cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__80757){
var vec__80758 = p__80757;
var dep_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80758,(0),null);
var dep_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80758,(1),null);
...
var view_state = (function (){var G__80761 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"view-state","view-state",-976675614)], null);
return (use_path_sub.cljs$core$IFn$_invoke$arity$1 ? use_path_sub.cljs$core$IFn$_invoke$arity$1(G__80761) : use_path_sub.call(null,G__80761));
})();
var map__80755 = props;
var map__80755__$1 = (((((!((map__80755 == null))))?(((((map__80755.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__80755.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__80755):map__80755);
var data__GT_layers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80755__$1,new cljs.core.Keyword("deck","data->layers","deck/data->layers",-2136602585));
...
return helix.core.get_react().createElement("div",helix.impl.props.merge_obj((function (){var obj81821 = ({"key":["deck",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props))].join(''),"ref":(function (c){
if(cljs.core.truth_(c)){
...
})(),new cljs.core.Keyword(null,"layers","layers",1944875032),cljs.core.to_array(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__81822){
var vec__81823 = p__81822;
var layer_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81823,(0),null);
var layers = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81823,(1),null);
...
if(goog.DEBUG === true){
var G__81826 = G__80748;
goog.object.set(G__81826,"displayName","org.browjure.deck.base/deck-component");
