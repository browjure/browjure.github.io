...
var sablono$util$ToString$to_str$dyn_78307 = (function (x){
...
return sablono$util$ToString$to_str$dyn_78307(x);
}
});
...
var sablono$util$ToURI$to_uri$dyn_78310 = (function (x){
var x__4428__auto__ = (((x == null))?null:x);
...
return sablono$util$ToURI$to_uri$dyn_78310(x);
}
});
...
var len__4736__auto___78314 = arguments.length;
var i__4737__auto___78315 = (0);
while(true){
if((i__4737__auto___78315 < len__4736__auto___78314)){
args__4742__auto__.push((arguments[i__4737__auto___78315]));

var G__78317 = (i__4737__auto___78315 + (1));
i__4737__auto___78315 = G__78317;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.util.as_str.cljs$lang$applyTo = (function (seq78253){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq78253));
}));
...
var vec__78257 = cljs.core.name(k).split("-");
var seq__78258 = cljs.core.seq(vec__78257);
var first__78259 = cljs.core.first(seq__78258);
var seq__78258__$1 = cljs.core.next(seq__78258);
var first_word = first__78259;
var words = seq__78258__$1;
...
var m__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__78260){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__78264,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__78264;
}
} else {
