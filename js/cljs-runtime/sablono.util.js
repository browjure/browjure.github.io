...
var sablono$util$ToString$to_str$dyn_80090 = (function (x){
...
return sablono$util$ToString$to_str$dyn_80090(x);
}
});
...
var sablono$util$ToURI$to_uri$dyn_80094 = (function (x){
var x__4428__auto__ = (((x == null))?null:x);
...
return sablono$util$ToURI$to_uri$dyn_80094(x);
}
});
...
var len__4736__auto___80100 = arguments.length;
var i__4737__auto___80101 = (0);
while(true){
if((i__4737__auto___80101 < len__4736__auto___80100)){
args__4742__auto__.push((arguments[i__4737__auto___80101]));

var G__80106 = (i__4737__auto___80101 + (1));
i__4737__auto___80101 = G__80106;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.util.as_str.cljs$lang$applyTo = (function (seq79992){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq79992));
}));
...
var vec__80004 = cljs.core.name(k).split("-");
var seq__80005 = cljs.core.seq(vec__80004);
var first__80006 = cljs.core.first(seq__80005);
var seq__80005__$1 = cljs.core.next(seq__80005);
var first_word = first__80006;
var words = seq__80005__$1;
...
var m__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__80014){
var vec__80016 = p__80014;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80016,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80016,(1),null);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__80027,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__80027;
}
} else {
