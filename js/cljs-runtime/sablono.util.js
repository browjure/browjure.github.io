...
var sablono$util$ToString$to_str$dyn_79444 = (function (x){
...
return sablono$util$ToString$to_str$dyn_79444(x);
}
});
...
var sablono$util$ToURI$to_uri$dyn_79448 = (function (x){
var x__4428__auto__ = (((x == null))?null:x);
...
return sablono$util$ToURI$to_uri$dyn_79448(x);
}
});
...
var len__4736__auto___79450 = arguments.length;
var i__4737__auto___79451 = (0);
while(true){
if((i__4737__auto___79451 < len__4736__auto___79450)){
args__4742__auto__.push((arguments[i__4737__auto___79451]));

var G__79453 = (i__4737__auto___79451 + (1));
i__4737__auto___79451 = G__79453;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.util.as_str.cljs$lang$applyTo = (function (seq79374){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq79374));
}));
...
var vec__79385 = cljs.core.name(k).split("-");
var seq__79386 = cljs.core.seq(vec__79385);
var first__79387 = cljs.core.first(seq__79386);
var seq__79386__$1 = cljs.core.next(seq__79386);
var first_word = first__79387;
var words = seq__79386__$1;
...
var m__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__79394){
var vec__79395 = p__79394;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79395,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79395,(1),null);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__79402,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__79402;
}
} else {
