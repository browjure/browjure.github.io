...
var sablono$interpreter$IInterpreter$interpret$dyn_125910 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_125910(this$);
}
});
...
var x125845_125914 = ctor.prototype;
(x125845_125914.onChange = (function (event){
var this$ = this;
...
(x125845_125914.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
(x125845_125914.render = (function (){
var this$ = this;
...
switch (G__125856) {
case "input":
var G__125857 = ((cljs.core.object_QMARK_(props))?props.type:false);
switch (G__125857) {
case "radio":
...
var len__4736__auto___125921 = arguments.length;
var i__4737__auto___125922 = (0);
while(true){
if((i__4737__auto___125922 < len__4736__auto___125921)){
args__4742__auto__.push((arguments[i__4737__auto___125922]));

var G__125925 = (i__4737__auto___125922 + (1));
i__4737__auto___125922 = G__125925;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq125859){
var G__125860 = cljs.core.first(seq125859);
var seq125859__$1 = cljs.core.next(seq125859);
var G__125861 = cljs.core.first(seq125859__$1);
var seq125859__$2 = cljs.core.next(seq125859__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__125860,G__125861,seq125859__$2);
}));
...
var vec__125876 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125876,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125876,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125876,(2),null);
