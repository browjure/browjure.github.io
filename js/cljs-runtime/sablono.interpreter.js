...
var sablono$interpreter$IInterpreter$interpret$dyn_80701 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_80701(this$);
}
});
...
var x80629_80702 = ctor.prototype;
(x80629_80702.onChange = (function (event){
var this$ = this;
...
(x80629_80702.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__80649) {
case "input":
var G__80650 = ((cljs.core.object_QMARK_(props))?props.type:false);
switch (G__80650) {
case "radio":
...
var len__4736__auto___80711 = arguments.length;
var i__4737__auto___80712 = (0);
while(true){
if((i__4737__auto___80712 < len__4736__auto___80711)){
args__4742__auto__.push((arguments[i__4737__auto___80712]));

var G__80713 = (i__4737__auto___80712 + (1));
i__4737__auto___80712 = G__80713;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq80654){
var G__80655 = cljs.core.first(seq80654);
var seq80654__$1 = cljs.core.next(seq80654);
var G__80656 = cljs.core.first(seq80654__$1);
var seq80654__$2 = cljs.core.next(seq80654__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__80655,G__80656,seq80654__$2);
}));
...
var vec__80669 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80669,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80669,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80669,(2),null);
