...
null);_typedArrayManager["default"].release(this.state.allocatedValue)}},{key:"getShaderAttributes",value:function(id,options){if(this.doublePrecision){var shaderAttributes={},isBuffer64Bit=this.value instanceof Float64Array;var JSCompiler_object_inline_low_2642=this.getAccessor();options=resolveShaderAttribute(JSCompiler_object_inline_low_2642,options||{});JSCompiler_object_inline_low_2642=_objectSpread(_objectSpread({},options),{},{offset:options.offset+4*JSCompiler_object_inline_low_2642.size});
shaderAttributes[id]=new _shaderAttribute["default"](this,options);shaderAttributes["".concat(id,"64Low")]=isBuffer64Bit?new _shaderAttribute["default"](this,JSCompiler_object_inline_low_2642):new Float32Array(this.size);return shaderAttributes}return options?(shaderAttributes=resolveShaderAttribute(this.getAccessor(),options),(0,_defineProperty2["default"])({},id,new _shaderAttribute["default"](this,shaderAttributes))):(0,_defineProperty2["default"])({},id,this)}},{key:"getBuffer",value:function(){return this.state.constant?
