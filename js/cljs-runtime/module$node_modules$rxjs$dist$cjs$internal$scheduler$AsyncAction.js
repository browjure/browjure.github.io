...
this.pending=!1;if(state=this._execute(state,delay))return state;!1===this.pending&&null!=this.id&&(this.id=this.recycleAsyncId(this.scheduler,this.id,null))};AsyncAction.prototype._execute=function(state,_delay){_delay=!1;try{this.work(state)}catch(e){_delay=!0;var errorValue=!!e&&e||Error(e)}if(_delay)return this.unsubscribe(),errorValue};AsyncAction.prototype.unsubscribe=function(){if(!this.closed){var id=this.id,scheduler=this.scheduler,actions=scheduler.actions;this.work=this.state=this.scheduler=
null;this.pending=!1;arrRemove_1.arrRemove(actions,this);null!=id&&(this.id=this.recycleAsyncId(scheduler,id,null));this.delay=null;_super.prototype.unsubscribe.call(this)}};return AsyncAction}(global.Action);exports.AsyncAction=require}
