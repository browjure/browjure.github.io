...
var deps = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__79884){
var vec__79886 = p__79884;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79886,(0),null);
var vec__79889 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79886,(1),null);
var dataset__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79889,(0),null);
var attribute = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79889,(1),null);
...
var vec__79894 = module$node_modules$react$index.useState(init_value);
var state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79894,(0),null);
var set_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79894,(1),null);
...
org.browjure.state.use_combined_sub = (function org$browjure$state$use_combined_sub(p__79899){
var map__79900 = p__79899;
var map__79900__$1 = (((((!((map__79900 == null))))?(((((map__79900.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__79900.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__79900):map__79900);
var deps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79900__$1,new cljs.core.Keyword(null,"deps","deps",1883360319));
var reduce_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79900__$1,new cljs.core.Keyword(null,"reduce-fn","reduce-fn",1170414925));
var init_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79900__$1,new cljs.core.Keyword(null,"init-value","init-value",-374892331));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79900__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var value = org.browjure.state.use_path_sub(path,init_value);
var dep_subjects = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__79904){
var vec__79905 = p__79904;
var dep_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79905,(0),null);
var dep_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79905,(1),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__79916_SHARP_,p2__79917_SHARP_){
return (p1__79916_SHARP_[p2__79917_SHARP_]);
