...
var deps = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__80600){
var vec__80601 = p__80600;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80601,(0),null);
var vec__80604 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80601,(1),null);
var dataset__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80604,(0),null);
var attribute = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80604,(1),null);
...
var vec__80613 = module$node_modules$react$index.useState(init_value);
var state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80613,(0),null);
var set_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80613,(1),null);
...
org.browjure.state.use_combined_sub = (function org$browjure$state$use_combined_sub(p__80616){
var map__80617 = p__80616;
var map__80617__$1 = (((((!((map__80617 == null))))?(((((map__80617.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__80617.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__80617):map__80617);
var deps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80617__$1,new cljs.core.Keyword(null,"deps","deps",1883360319));
var reduce_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80617__$1,new cljs.core.Keyword(null,"reduce-fn","reduce-fn",1170414925));
var init_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80617__$1,new cljs.core.Keyword(null,"init-value","init-value",-374892331));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80617__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var value = org.browjure.state.use_path_sub(path,init_value);
var dep_subjects = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__80619){
var vec__80620 = p__80619;
var dep_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80620,(0),null);
var dep_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80620,(1),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__80624_SHARP_,p2__80625_SHARP_){
return (p1__80624_SHARP_[p2__80625_SHARP_]);
