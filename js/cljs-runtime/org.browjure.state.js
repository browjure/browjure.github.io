...
var deps = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__86352){
var vec__86353 = p__86352;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86353,(0),null);
var vec__86356 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86353,(1),null);
var dataset__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86356,(0),null);
var attribute = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86356,(1),null);
...
var vec__86363 = module$node_modules$react$index.useState(init_value);
var state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86363,(0),null);
var set_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86363,(1),null);
...
org.browjure.state.use_combined_sub = (function org$browjure$state$use_combined_sub(p__86366){
var map__86367 = p__86366;
var map__86367__$1 = (((((!((map__86367 == null))))?(((((map__86367.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__86367.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__86367):map__86367);
var deps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86367__$1,new cljs.core.Keyword(null,"deps","deps",1883360319));
var reduce_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86367__$1,new cljs.core.Keyword(null,"reduce-fn","reduce-fn",1170414925));
var init_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86367__$1,new cljs.core.Keyword(null,"init-value","init-value",-374892331));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86367__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var value = org.browjure.state.use_path_sub(path,init_value);
var dep_subjects = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__86369){
var vec__86370 = p__86369;
var dep_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86370,(0),null);
var dep_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86370,(1),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__86376_SHARP_,p2__86377_SHARP_){
return (p1__86376_SHARP_[p2__86377_SHARP_]);
