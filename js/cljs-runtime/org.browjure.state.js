...
var deps = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__81891){
var vec__81892 = p__81891;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81892,(0),null);
var vec__81895 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81892,(1),null);
var dataset__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81895,(0),null);
var attribute = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81895,(1),null);
...
var vec__81929 = module$node_modules$react$index.useState(init_value);
var state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81929,(0),null);
var set_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81929,(1),null);
...
org.browjure.state.use_combined_sub = (function org$browjure$state$use_combined_sub(p__81949){
...
var deps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81950__$1,new cljs.core.Keyword(null,"deps","deps",1883360319));
var reduce_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81950__$1,new cljs.core.Keyword(null,"reduce-fn","reduce-fn",1170414925));
var init_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81950__$1,new cljs.core.Keyword(null,"init-value","init-value",-374892331));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81950__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var value = org.browjure.state.use_path_sub(path,init_value);
var dep_subjects = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__81963){
var vec__81965 = p__81963;
var dep_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81965,(0),null);
var dep_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81965,(1),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__81968_SHARP_,p2__81969_SHARP_){
return (p1__81968_SHARP_[p2__81969_SHARP_]);
