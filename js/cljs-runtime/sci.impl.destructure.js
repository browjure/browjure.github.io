...
var G__119957 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__119958 = n;
var G__119959 = cljs.core.nnext(bs);
var G__119960 = true;
ret = G__119957;
n = G__119958;
bs = G__119959;
seen_rest_QMARK_ = G__119960;
continue;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__119716_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4126__auto__ = mkns;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return cljs.core.namespace(p1__119716_SHARP_);
}
})(),cljs.core.name(p1__119716_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__119717_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4126__auto__ = mkns;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return cljs.core.namespace(p1__119717_SHARP_);
}
})(),cljs.core.name(p1__119717_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__119718_SHARP_,p2__119719_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__119718_SHARP_,p2__119719_SHARP_,(function (){var fexpr__119887 = cljs.core.val(entry);
return (fexpr__119887.cljs$core$IFn$_invoke$arity$1 ? fexpr__119887.cljs$core$IFn$_invoke$arity$1(p2__119719_SHARP_) : fexpr__119887.call(null,p2__119719_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__119888 = cljs.core.key(entry);
return (fexpr__119888.cljs$core$IFn$_invoke$arity$1 ? fexpr__119888.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__119888.call(null,bes));
})());
...
var G__120004 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__120005 = cljs.core.next(bes);
ret = G__120004;
bes = G__120005;
continue;
} else {
...
var temp__5751__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__119720_SHARP_){
return (cljs.core.first(p1__119720_SHARP_) instanceof cljs.core.Keyword);
}),bents));
