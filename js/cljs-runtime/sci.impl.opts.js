...
var len__4736__auto___82529 = arguments.length;
var i__4737__auto___82530 = (0);
while(true){
if((i__4737__auto___82530 < len__4736__auto___82529)){
args__4742__auto__.push((arguments[i__4737__auto___82530]));

var G__82531 = (i__4737__auto___82530 + (1));
i__4737__auto___82530 = G__82531;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.opts.process_permissions.cljs$lang$applyTo = (function (seq82508){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq82508));
}));
...
var G__82533 = null;
var G__82533__1 = (function (msg){
return (new Error(msg));
});
var G__82533__2 = (function (msg,filename){
return (new Error(msg,filename));
});
var G__82533__3 = (function (msg,filename,line){
return (new Error(msg,filename,line));
});
G__82533 = function(msg,filename,line){
switch(arguments.length){
case 1:
return G__82533__1.call(this,msg);
case 2:
return G__82533__2.call(this,msg,filename);
case 3:
return G__82533__3.call(this,msg,filename,line);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__82533.cljs$core$IFn$_invoke$arity$1 = G__82533__1;
G__82533.cljs$core$IFn$_invoke$arity$2 = G__82533__2;
G__82533.cljs$core$IFn$_invoke$arity$3 = G__82533__3;
return G__82533;
})()
], null),new cljs.core.Symbol(null,"cljs.core.Delay","cljs.core.Delay",-1917476777,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.Delay,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__82513_SHARP_){
return (new cljs.core.Delay(p1__82513_SHARP_,null));
})], null),new cljs.core.Symbol(null,"goog.string.StringBuffer","goog.string.StringBuffer",-1220229842,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),goog.string.StringBuffer,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__82514_SHARP_){
return (new goog.string.StringBuffer(p1__82514_SHARP_));
})], null)], null);
...
var vec__82515 = temp__5751__auto__;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82515,(0),null);
var class_opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82515,(1),null);
var G__82541 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(class__GT_opts,sym,((cljs.core.map_QMARK_(class_opts))?class_opts:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),class_opts], null)));
var G__82542 = cljs.core.rest(kvs);
class__GT_opts = G__82541;
kvs = G__82542;
continue;
} else {
 ...
 * Initializes options
 */
sci.impl.opts.init = (function sci$impl$opts$init(p__82518){
var map__82519 = p__82518;
var map__82519__$1 = (((((!((map__82519 == null))))?(((((map__82519.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__82519.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__82519):map__82519);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82519__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82519__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82519__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82519__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82519__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82519__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82519__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var preset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82519__$1,new cljs.core.Keyword(null,"preset","preset",777387345));
var realize_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82519__$1,new cljs.core.Keyword(null,"realize-max","realize-max",-1846442543));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82519__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var dry_run = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82519__$1,new cljs.core.Keyword(null,"dry-run","dry-run",-1102788647));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82519__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82519__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82519__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
