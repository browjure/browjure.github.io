...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58439__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
}catch (e58438){var _e = e58438;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___58474 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5751__auto___58474)){
var seen_errors_58475 = temp__5751__auto___58474;
if(cljs.core.truth_(seen_errors_58475.has(self))){
} else {
seen_errors_58475.add(self);

var temp__5753__auto___58476 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5753__auto___58476)){
var sense_58477 = temp__5753__auto___58476;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_58477)].join(''));
} else {
}
}
} else {
